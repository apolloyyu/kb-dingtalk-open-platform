...
archived: false
method: POST
endpoint: https://oapi.dingtalk.com/topapi/serviceaccount/update
api_version: v1-oapi
app_types: 企业内部应用
...
- optional: name(String), avatar_media_id(String), brief(String), desc(String), preview_media_id(String), status(String)
