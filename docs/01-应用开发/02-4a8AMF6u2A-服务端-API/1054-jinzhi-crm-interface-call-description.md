...
| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [客户资料](1056-add-or-edit-customer-profile.md) | 新增或编辑客户资料。 | 新版 |
| [客户公共池](1057-add-or-edit-customer-public-pools.md) | 新增或编辑客户公共池。 | 新版 |

#### **联系人**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [联系人](1058-add-or-edit-contacts.md) | 新增或编辑联系人。 | 新版 |

#### **合同**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [合同订单](1059-add-or-edit-contract-orders.md) | 新增或编辑合同订单。 | 新版 |
| [发货单](1060-add-or-edit-invoices.md) | 新增或编辑发货单。 | 新版 |
| [销售换货单](1061-add-or-edit-a-sales-order.md) | 新增或编辑销售换货单。 | 新版 |

#### **销售**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [销售机会](1062-add-or-edit-opportunities.md) | 新增或编辑销售机会。 | 新版 |
| [报价记录](1063-add-or-edit-quotation-records.md) | 新增或编辑报价记录。 | 新版 |

#### **采购**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [采购单](1064-edit-purchase-order.md) | 新增或编辑采购单。 | 新版 |

#### **生产**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [生产单](1065-add-or-edit-a-production-order.md) | 新增或编辑生产单。 | 新版 |

#### **产品**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [产品信息](1066-add-or-edit-product-information.md) | 新增或编辑产品信息。 | 新版 |

#### **库存**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [入库单](1067-add-or-edit-a-shipment-record.md) | 新增或编辑入库单。 | 新版 |
| [出库单](1068-add-or-edit-an-issue-ticket.md) | 新增或编辑出库单。 | 新版 |

#### **数据**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [获取数据列表](1070-obtain-the-data-list.md) | 获取各种单据的列表数据。 | 新版 |
| [获取数据详情](1069-queries-data-details.md) | 获取各种单据的详情数据。 | 新版 |

## 开放教程

钉钉提供了金智CRM接口接入流程示例，请参见[制造业订单交付全过程管理](1055-management-of-order-delivery-in-the-manufacturing-industry.md)。
