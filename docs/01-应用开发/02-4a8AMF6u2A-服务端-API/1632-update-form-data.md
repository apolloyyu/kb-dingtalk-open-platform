...
doc_id: "OPCLvGCUi6"
updated_at: "2026-08-25 09:39:29"
---

> Source: https://open.dingtalk.com/document/development/update-form-data
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 宜搭 > 表单 > 更新表单数据
> Updated: 2026-08-25 09:39:29
...
> - 未接入的开发者建议使用新版[更新表单数据](0317-api-updateformdata-v2.md)接口，已接入用户不受影响。
...
| formInstanceId | String | 是 | 流程实例ID，调用[保存表单数据](1631-save-form-data.md)接口获取。 |
