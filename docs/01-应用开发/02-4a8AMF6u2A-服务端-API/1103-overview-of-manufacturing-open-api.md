...
| API | API说明 | API版本 |
| --- | --- | --- |
| [日清月结-计件报工接口](1105-riqing-monthly-settlement-piece-rate-reporting-interface.md) | 连接已有的MES应用，上报计件数据到钉钉。 | 新版 |
| [日清月结-查询计件报工数据](1106-riqing-monthly-settlement-query-interface-for-piece-rate-reporting.md) | 连接已有的MES应用，查询计件报工的数据。 | 新版 |

## **使用教程**

钉钉提供了制造业接口接入流程示例。

- [计件报工基本使用流程](1104-basic-use-process-of-a-piece-report-worker.md)
