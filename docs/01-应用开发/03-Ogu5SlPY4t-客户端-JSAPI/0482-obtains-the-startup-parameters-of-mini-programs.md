...
doc_id: "5Q1YdXSFc5"
updated_at: "2026-09-01 09:16:32"
---

> Source: https://open.dingtalk.com/document/development/obtains-the-startup-parameters-of-mini-programs
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 基础 API > 获取小程序启动时的参数
> Updated: 2026-09-01 09:16:32
...
> - 本接口获取的信息与小程序启动方法[onLaunch(options: Object)](0434-app-js-registration-mini-program-1.md#section-kym-z05-hv9)内携带的参数信息是一致的。
>
> ```
> App({
>   onLaunch(options) {
