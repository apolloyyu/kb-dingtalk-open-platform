...
doc_id: "NpXanZKhdz"
updated_at: "2026-08-28 10:26:30"
---

> Source: https://open.dingtalk.com/document/development/user-messages-to-groups
> Path: 应用开发 / 客户端 JSAPI / 酷应用 > 用户身份发送卡片消息到群
> Updated: 2026-08-28 10:26:30
...
![消息发送](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1993887871/p578397.png)

### 发送成功

![发送群消息成功](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1993887871/p578398.png)
...
| context.corpId | String | 是 | 企业CorpId，用于校验群所属企业，仅能安装到该企业的内部群。  **[!NOTE]**  如何获取Appkey，请参见[基础概念-CorpId](../01-XOnnmGCTbn-开发指南/0001-basic-concepts-beta.md#7d9825efaadw7)。 |
...
| sendCardRequest.cardData | Object | 是 | 卡片数据。详情参见[发送钉钉互动卡片（高级版）](../02-4a8AMF6u2A-服务端-API/1475-send-interactive-dynamic-cards-1.md)cardData字段。 |
