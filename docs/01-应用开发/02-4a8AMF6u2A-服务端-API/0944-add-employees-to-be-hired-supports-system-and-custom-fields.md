...
| groupId | String | 否 | 分组ID，可调用[获取花名册元数据](0936-intelligent-personnel-roster-metadata-query.md)接口获取group\_id参数值。 |
...
| fieldCode | String | 否 | 分组内字段fieldCode，可调用[获取花名册元数据](0936-intelligent-personnel-roster-metadata-query.md)接口获取的field\_code参数值。 |
