...
> Path: 应用开发 / 服务端 API / 通讯录管理 > 通讯录可见性管理 > 新增或更新通讯录隐藏设置
> Updated: 2026-06-02 09:24:43
...
| objectStaffIds | Array of String | 否 | 需要被隐藏的员工userId列表，可通过[通过免登码获取用户信息](0023-obtain-the-userid-of-a-user-by-using-the-log-free.md)获得userId参数值。      objectStaffIds、objectDeptIds、objectTagIds三个参数内元素个数之和不能超过50。 |
...
| objectTagIds | Array of Long | 否 | 需要被隐藏的角色roleId列表，可通过[获取角色列表](0088-obtains-a-list-of-enterprise-roles.md)接口获得id参数值。      objectStaffIds、objectDeptIds、objectTagIds三个参数内元素个数之和不能超过50。 |
| excludeStaffIds | Array of String | 否 | 不受本次隐藏设置影响的员工userId列表，可通过[通过免登码获取用户信息](0023-obtain-the-userid-of-a-user-by-using-the-log-free.md)获得userId参数值。      excludeStaffIds、excludeDeptIds、excludeTagIds三个参数内元素个数之和不能超过50。 |
...
| excludeTagIds | Array of Long | 否 | 不受本次隐藏设置影响的角色ID列表，可通过[获取角色列表](0088-obtains-a-list-of-enterprise-roles.md)接口获得id参数值。      excludeStaffIds、excludeDeptIds、excludeTagIds三个参数内元素个数之和不能超过50。 |
