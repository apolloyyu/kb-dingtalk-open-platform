...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| chatid | String | 是 | chate39f5xxxxxx335 | 群会话的ID。   - 服务端API获取，调用[创建群](1483-session-management-creates-groups.md)接口的返回chatid字段。 - 前端API获取，小程序调用[选择会话](../03-Ogu5SlPY4t-客户端JSAPI/0744-select-session.md)，微应用调用[根据corpid选择会话](../03-Ogu5SlPY4t-客户端JSAPI/0803-select-session-based-on-corpid.md)。 |
