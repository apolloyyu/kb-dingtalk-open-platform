...
> Path: 应用开发 / 服务端 API / 钉钉工作台 > 批量添加最近使用应用
> Updated: 2026-06-02 19:48:40
...
| agentId | String | 是 | 组织开通的应用Id，可通过调用[获取企业所有应用列表](0865-obtains-a-list-of-all-enterprise-applications.md)接口获取返回参数`agentId`字段。 |
