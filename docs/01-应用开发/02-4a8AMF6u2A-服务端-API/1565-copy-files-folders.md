...
doc_id: "0O4Qctfaed"
updated_at: "2026-08-25 09:38:25"
---

> Source: https://open.dingtalk.com/document/development/copy-files-folders
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 文档/文件 > 钉盘 > 文件管理 > 拷贝文件（夹）
> Updated: 2026-08-25 09:38:25
...
> - 未接入的开发者建议使用新版[复制文件或文件夹](0654-copy-an-object.md)接口，已接入用户不受影响。
