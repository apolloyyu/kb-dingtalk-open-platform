...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| targetOpenConversationId | String | 是 | 开放群ID，可调用[创建场景服务群](1117-create-a-scenario-service-group.md)接口获取openConversationId参数值。 |
...
| atUnionIds | Array of String | 否 | 被@人的unionId列表，可通过[查询用户详情](0055-query-user-details.md)接口获取用户unionId值。 |
