...
group: "应用开发"
tab: "客户端 JSAPI"
breadcrumb: "历史文档（不推荐） > 小程序 > 框架 > ACSS 语法参考"
doc_id: "ZPXSwWS2Bc"
updated_at: "2026-09-01 09:16:10"
---

> Source: https://open.dingtalk.com/document/development/mini-app-acss-style-syntax-reference
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 框架 > ACSS 语法参考
> Updated: 2026-09-01 09:16:10
...
- 使用 css 变量：小程序支持css变量，设置变量并使用可以快速适配显示模式
  ...
  ```
- 高级用法：小程序新增了关于显示模式的JSAPI和事件。详情请参考[显示模式](0520-display-mode.md)。
