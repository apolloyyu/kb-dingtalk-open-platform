---
title: "获取企业单聊统计数据"
source_url: "https://open.dingtalk.com/document/development/queries-the-statistics-on-one-time-enterprise-chats"
namespace: "development"
slug: "queries-the-statistics-on-one-time-enterprise-chats"
group: "应用开发"
tab: "服务端 API"
breadcrumb: "历史文档（不推荐） > 数据目录 > 获取企业单聊统计数据"
doc_id: "6DOdjiWMdy"
updated_at: "2026-08-27 14:10:50"
---

> Source: https://open.dingtalk.com/document/development/queries-the-statistics-on-one-time-enterprise-chats
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 数据目录 > 获取企业单聊统计数据
> Updated: 2026-08-27 14:10:50

# 获取企业单聊统计数据

调用本接口获取企业即时沟通中单聊的统计数据。
