...
doc_id: "nO0J0AtxYv"
updated_at: "2026-09-01 09:17:13"
---

> Source: https://open.dingtalk.com/document/development/obtains-a-list-of-local-cached-files
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 文件管理器 > 获取本地缓存文件列表
> Updated: 2026-09-01 09:17:13
...
> **[!NOTE]**
>
> 本接口获取的是调用[保存文件](0675-save-file.md)接口保存为本地缓存的文件，保存为本地用户的文件不支持获取。
