...
> Path: 应用开发 / 服务端 API / 行业与生态 > 生态开放 > 阿里商旅 > 出差申请 > 新建审批单
...
| cost\_center\_id | Number | 是 | 3454232 | 商旅成本中心id，可通过[查询成本中心](1018-query-cost-center.md)接口获取。  **[!NOTE]**  若不填则第三方成本中心id必填。 |
| thirdpart\_cost\_center\_id | String | 否 | 3454232 | 第三方成本中心id，可通过[查询成本中心](1018-query-cost-center.md)接口获取。  **[!NOTE]**  若不填则商旅成本中心id必填。 |
| invoice\_id | Number | 是 | 3891xxxx | 发票id，可调用[查询可用发票列表](1042-query-available-invoices.md)接口获取。 |
