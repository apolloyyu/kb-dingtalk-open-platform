...
| apply\_shift\_id | Number | 是 | 1234566 | 申请人换班日期当天的班次ID，可通过[批量查询人员排班信息](0205-query-batch-scheduling-information.md)接口获取shift\_id参数值。 |
| target\_shift\_id | Number | 是 | 1234566 | 被换班人换班日期当天的班次ID，可通过[批量查询人员排班信息](0205-query-batch-scheduling-information.md)接口获取shift\_id参数值。 |
| reback\_apply\_shift\_id | Number | 是 | 1234566 | 申请人还班日期当天的班次ID，可通过[批量查询人员排班信息](0205-query-batch-scheduling-information.md)接口获取shift\_id参数值。 |
| reback\_target\_shift\_id | Number | 是 | 1234566 | 被换班人还班日期当天的班次ID，可通过[批量查询人员排班信息](0205-query-batch-scheduling-information.md)接口获取shift\_id参数值。 |
