...
> Path: 应用开发 / 服务端 API / 音视频 > 直播 > 修改直播属性信息
> Updated: 2026-06-02 09:10:43
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| liveId | String | 是 | 直播ID，可调用[创建直播](0428-create-live-streaming.md)接口liveId参数值。 |
| unionId | String | 是 | 主播的unionId，可调用[查询用户详情](0055-query-user-details.md)接口获取unionid参数值。 |
| title | String | 否 | 直播标题。 |
