---
title: "通讯录授权范围变更事件"
source_url: "https://open.dingtalk.com/document/development/address-book-authorization-scope-change-event"
namespace: "development"
slug: "address-book-authorization-scope-change-event"
group: "应用开发"
tab: "事件订阅"
breadcrumb: "历史文档（不推荐） > HTTP回调 > 事件列表 > 通讯录授权范围变更事件"
doc_id: "gLPiikg3UP"
updated_at: "2025-10-16 14:31:46"
---

> Source: https://open.dingtalk.com/document/development/address-book-authorization-scope-change-event
> Path: 应用开发 / 事件订阅 / 历史文档（不推荐） > HTTP回调 > 事件列表 > 通讯录授权范围变更事件
> Updated: 2025-10-16 14:31:46
