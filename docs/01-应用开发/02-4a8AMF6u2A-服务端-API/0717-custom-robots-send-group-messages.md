...
> Path: 应用开发 / 服务端 API / 即时通信 > 机器人 > 发送普通消息 > 自定义机器人发送群消息
...
| picUrl | String | 否 | @aubHxxxxx | 链接消息内的图片地址，建议使用[上传媒体文件](0645-upload-media-files.md)接口获取。 |
...
| picURL | String | 否 | @aubHxxxxx | feedCard消息内每条内容的图片URL，建议使用[上传媒体文件](0645-upload-media-files.md)接口获取。 |
