...
3. 实现免登，企业内部应用请参考[网页应用（H5微应用）免登](../02-4a8AMF6u2A-服务端-API/0018-enterprise-internal-application-logon-free.md)，第三方企业应用请参考[开发并测试第三方企业网页应用（H5）免登](../02-4a8AMF6u2A-服务端-API/0021-web-applications-h5.md)。
