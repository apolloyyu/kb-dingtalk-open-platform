...
> - 未接入的开发者建议使用新版[删除个人或企业客户数据](1351-delete-crm-personal-customer.md)接口，已接入用户不受影响。
...
| data\_id | String | 是 | INST\_XX | 客户实例ID，可通过[根据指定条件查询个人或企业客户数据](1356-obtains-crm-individual-customers-in-batches-based-on-specified-query.md)接口获取。 |
