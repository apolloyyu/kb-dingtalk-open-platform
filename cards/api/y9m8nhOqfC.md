...
archived: false
method: POST
endpoint: https://api.dingtalk.com/v2.0/yida/forms/resources/roles/upsert
api_version: v2-new
app_types: 企业内部应用
...
- membersInfo (String, required): memberId为新增或者更新的userId manageScopes为管理范围，其中all代表管理范围为「所有人」。
