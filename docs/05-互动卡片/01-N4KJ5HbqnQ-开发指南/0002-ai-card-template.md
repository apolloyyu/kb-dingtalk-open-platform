...
为了降低业务的使用成本，我们针对 AI 卡片模板预设了几个状态，包含处理中、输入中、完成、失败等状态。业务可以通过调用 [AI卡片流式更新](../../01-应用开发/02-4a8AMF6u2A-服务端-API/0786-api-streamingupdate.md)通过传递 isFinalize、isError 参数控制状态的变更。
