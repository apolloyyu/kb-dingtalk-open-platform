...
3. 获取考勤组内参与考勤人员信息
   ...
   - 调用服务端API-[获取参与考勤人员](0182-batch-query-of-attendance-group-members.md)接口，获取参与考勤人员信息。
...
> **[!NOTE]**
>
> 考勤组管理的操作流程，详情参见[创建、获取、更新及删除考勤组](0162-operation-related-to-attendance-group.md)。
