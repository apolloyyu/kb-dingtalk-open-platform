...
> Path: 应用开发 / 服务端 API / 通讯录管理 > 上下级组织（原关联组织） > 解除关联组织
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| attachDeptId | Long | 是 | 伙伴组织在上下游组织内的部门ID，上下游组织通过[获取部门列表](0081-user-management-acquires-the-list-departments.md)接口获取dept\_id参数值。 |
