...
doc_id: "MkLLhCJE13"
updated_at: "2026-06-01 15:45:01"
---

> Source: https://open.dingtalk.com/document/development/the-union-id-that-you-want-to-query-you-can
> Path: 应用开发 / 服务端 API / 通讯录管理 > 企业账号 > 根据原unionId查询迁移后的unionId
> Updated: 2026-06-01 15:45:01
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 是 | 原普通账号的unionId，可调用[通过免登码获取用户信息](0023-obtain-the-userid-of-a-user-by-using-the-log-free.md)获取unionid参数值。 |
