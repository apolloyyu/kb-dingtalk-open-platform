...
> Path: 应用开发 / 服务端 API / Teambition 项目管理 > 任务 > 项目任务 > 获取任务详情
> Updated: 2026-06-03 09:26:03
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| taskId | String | 否 | 任务ID集合，多个taskId，使用逗号分隔，可通过调用[查询项目中的任务](1230-query-tasks-in-a-project.md)接口，获取返回参数`taskId`字段。  **[!NOTE]**    与parentTaskId冲突（选其一）。 |
