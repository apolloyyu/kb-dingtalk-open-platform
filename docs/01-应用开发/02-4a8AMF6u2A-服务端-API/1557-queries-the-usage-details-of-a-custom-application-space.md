...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 文档/文件 > 钉盘 > 获取应用自定义空间使用详情
...
| agent\_id | String | 是 | 86881016 | 应用的AgentId。   - 企业内部应用可以在[开发者后台](https://open-dev.dingtalk.com/)的应用详情页获取。 - 第三方企业应用可以调用[获取企业授权信息](0041-obtains-the-basic-information-of-an-enterprise.md)接口获取。 |
