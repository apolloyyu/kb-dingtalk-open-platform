...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 是 | 当前访问资源所归属用户的unionId，需要操作者的unionId保持一致，可调用[查询用户详情](0055-query-user-details.md)接口获取unionid参数值。 |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| operatorId | String | 否 | 当前操作者的unionId，可调用[查询用户详情](0055-query-user-details.md)接口获取unionid参数值。 |
...
| executorIds | Array of String | 否 | 执行者的unionId列表，可调用[查询用户详情](0055-query-user-details.md)接口获取，最大数量1000。 |
| participantIds | Array of String | 否 | 参与者的unionId列表，可调用[查询用户详情](0055-query-user-details.md)接口获取，最大数量1000。 |
