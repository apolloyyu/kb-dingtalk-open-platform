...
> Path: 应用开发 / 服务端 API / 行业与生态 > 生态开放 > 阿里商旅 > 出差申请 > 修改申请单
...
| thirdpart\_business\_id | String | 否 | 12345 | 用户展示的外部审批单ID，调用[获取申请单列表](1026-search-enterprise-approval-form-data.md)接口获取。 |
