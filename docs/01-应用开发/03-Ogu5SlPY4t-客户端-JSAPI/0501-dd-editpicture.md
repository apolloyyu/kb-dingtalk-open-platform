...
doc_id: "PgpqCv4QHc"
updated_at: "2026-09-01 09:16:34"
---

> Source: https://open.dingtalk.com/document/development/dd-editpicture
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 多媒体 > 图片 > 编辑图片
> Updated: 2026-09-01 09:16:34
...
> **[!IMPORTANT]**
>
> 调用前请使用[dd.canIUse](0477-dd-caniuse.md)('editPicture')判断是否可用**。**
