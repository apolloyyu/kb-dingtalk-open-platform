---
title: "Agoal新增目标规则事件"
source_url: "https://open.dingtalk.com/document/development/events-agoal-objectiverule-add"
namespace: "development"
slug: "events-agoal-objectiverule-add"
group: "应用开发"
tab: "事件订阅"
breadcrumb: "Agoal > Agoal新增目标规则事件"
doc_id: "KAYL8SKLUD"
updated_at: "2025-11-28 19:03:29"
---

> Source: https://open.dingtalk.com/document/development/events-agoal-objectiverule-add
> Path: 应用开发 / 事件订阅 / Agoal > Agoal新增目标规则事件
> Updated: 2025-11-28 19:03:29
...
- `data.body`（object）
- `data.body.objectiveRuleId`（string，必填）：目标规则id
...
```
{
  ...
  "eventType": "agoal_objectiveRule_add",
...
- `body`（object，必填）
- `body.objectiveRuleId`（string，必填）：目标规则id
...
- `biz_data.body.objectiveRuleId`（string，必填）：目标规则id
