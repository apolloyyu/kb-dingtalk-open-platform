...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > e签宝 1.0 > 签署流程 > 获取流程任务用印审批列表
> Updated: 2026-08-25 09:37:38
...
> - 未接入的开发者建议使用新版[获取流程任务用印审批列表](1087-obtains-the-print-approval-list-for-process-tasks.md)接口，已接入用户不受影响。
