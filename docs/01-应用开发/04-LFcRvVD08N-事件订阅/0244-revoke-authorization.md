---
title: "解除授权事件"
source_url: "https://open.dingtalk.com/document/development/revoke-authorization"
namespace: "development"
slug: "revoke-authorization"
group: "应用开发"
tab: "事件订阅"
breadcrumb: "历史文档（不推荐） > HTTP回调 > 事件列表 > 解除授权事件"
doc_id: "MZQiJQ3OUO"
updated_at: "2025-10-16 14:31:45"
---

> Source: https://open.dingtalk.com/document/development/revoke-authorization
> Path: 应用开发 / 事件订阅 / 历史文档（不推荐） > HTTP回调 > 事件列表 > 解除授权事件
