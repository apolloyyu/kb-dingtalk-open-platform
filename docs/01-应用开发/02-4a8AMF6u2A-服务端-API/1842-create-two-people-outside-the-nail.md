...
doc_id: "Hncnf5uQth"
updated_at: "2026-08-27 14:22:15"
---

> Source: https://open.dingtalk.com/document/development/create-two-people-outside-the-nail
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 钉钉客联 > 创建钉外两人群
> Updated: 2026-08-27 14:22:15
...
| groupOwnerId | String | 是 | 群主在业务系统内的唯一标识。群主为钉外账号：钉外账号在业务系统内的唯一标志，长度限制为1～64个字符。例如：1107\*\*\*\*2120。 |
| appUserId | String | 是 | 钉外账号在业务系统内的唯一标志，长度限制为1～64个字符，调用[创建钉钉客联钉外账号](1844-create-bc-account-association.md)接口获取appUserId参数值。 |
| operatorId | String | 是 | 操作者在业务系统内的唯一标识，调用[创建钉钉客联钉外账号](1844-create-bc-account-association.md)接口获取。  可支持指定钉内账号或钉外账号为操作者：   - 若是钉内账号userId，长度限制为1～64个字符。例如：1745\*\*\*\*8777。 - 若是钉外账号在业务系统内的唯一标志，长度限制为1～64个字符。例如：1107\*\*\*\*2120。 |
