...
完成[创建自定义机器人](0083-custom-bot-creation-and-installation.md)流程。
...
2. 拿到开发服务内当前系统 timestamp 和加密 sign 签名值，将 timestamp 和 sign 拼接到 URL 中。
   ...
   详情可参考[自定义机器人发送群聊消息](../02-4a8AMF6u2A-服务端-API/0703-custom-bot-to-send-group-chat-messages.md)。
...
- [自定义机器人发送群消息 OpenAPI](../02-4a8AMF6u2A-服务端-API/0718-custom-robots-send-group-messages.md)
