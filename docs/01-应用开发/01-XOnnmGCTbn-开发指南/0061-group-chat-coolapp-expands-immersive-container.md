...
4. **页面模板**：以上的最佳实践和可复用的场景化模板。
   ...
   | **模块** | **以前** | **现在** |
   | --- | --- | --- |
   | **跳转协议** | [AppLink协议](../02-4a8AMF6u2A-服务端-API/1392-structure-of-applink.md)多，不够聚焦酷应用场景。 | 提供多种AppLink协议跳转，请参考[AppLink协议](../02-4a8AMF6u2A-服务端-API/1392-structure-of-applink.md)。 |
...
**步骤一**：提供多种AppLink协议跳转，请参考[AppLink协议](../02-4a8AMF6u2A-服务端-API/1392-structure-of-applink.md)。
