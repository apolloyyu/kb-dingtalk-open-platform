...
doc_id: "xdGFbWTcEy"
updated_at: "2026-09-01 09:16:35"
---

> Source: https://open.dingtalk.com/document/development/dd-addtabbaritem
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 界面 > TabBar > 添加tabBar页面
> Updated: 2026-09-01 09:16:35
...
使用[dd.canIUse](0477-dd-caniuse.md)('addTabBarItem')进行兼容性判断 。
