...
doc_id: "0Zm8aN8MoZ"
updated_at: "2026-08-27 14:24:09"
---

> Source: https://open.dingtalk.com/document/development/modify-the-avatar-of-a-communication-group
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 钉钉客联 > 修改钉钉客联互通群头像
> Updated: 2026-08-27 14:24:09
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| openConversationId | String | 是 | 群会话openConversationId，调用[创建钉钉客联钉外账号](1844-create-bc-account-association.md)接口获取，长度限制为1～32个字符。 |
| groupAvatar | String | 是 | 新的群头像地址，长度限制为1～1024个字符。 |
