...
| media\_id | String | 是 | @123456 | 文件media\_id，调用[获取文件上传信息](0675-obtain-file-upload-informations.md)接口或者[提交文件](0676-submittal-file.md)接口获取。  **[!NOTE]**  参数需要utf-8 urlEncode处理。 |
