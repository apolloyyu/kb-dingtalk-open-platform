...
> Path: 应用开发 / 服务端 API / 宜搭 > 表单 > 批量创建表单实例
> Updated: 2026-06-03 10:12:02
...
| formDataJsonList | Array of String | 是 | 表单实例数据，格式参考[创建或更新表单数据格式说明](0366-instructions-for-creating-or-updating-form-data-format.md)。 |
