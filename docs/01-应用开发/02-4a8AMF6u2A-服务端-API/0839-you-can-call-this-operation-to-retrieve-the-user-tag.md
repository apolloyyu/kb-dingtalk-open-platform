...
本接口目前仅支持专属钉钉企业调用，如何申请开通专属钉钉，请参考[专属钉钉开通流程](https://alidocs.dingtalk.com/i/p/Y7kmbokZp3pgGLq2/docs/YQBnd5ExVEwmZPaeUdZL5D9N8yeZqMmz?spm=ding_open_doc.document.0.0.678c7315hXlPOx)。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| userId | String | 是 | 用户userId，可调用[查询用户详情](0055-query-user-details.md)接口获取。 |
