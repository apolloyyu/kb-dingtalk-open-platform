...
> Path: 应用开发 / 服务端 API / 宜搭 > 表单 > 获取子表组件数据
> Updated: 2026-06-03 10:11:46
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| formInstanceId | String | 是 | 要查询的实例的实例ID，可通过[获取多个表单实例ID](0323-api-searchformdataidlist-v2.md)接口获取。 |
