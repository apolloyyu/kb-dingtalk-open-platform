...
doc_id: "FteSNkHjor"
updated_at: "2026-09-02 18:14:08"
---

> Source: https://open.dingtalk.com/document/development/redirects-to-a-specific-session-based-on-the-chatid-h5
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > H5微应用 > JSAPI参考 > 会话 > 根据chatId跳转到对应会话
> Updated: 2026-09-02 18:14:08
...
| chatId | String | 会话id。可调用[根据corpid选择会话](0767-select-session-based-on-corpid.md)获取。 |
