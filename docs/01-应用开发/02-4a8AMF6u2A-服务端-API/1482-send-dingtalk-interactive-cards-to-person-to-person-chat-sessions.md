...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| cardTemplateId | String | 是 | 卡片模板ID，可通过[卡片平台](https://open-dev.dingtalk.com/fe/card)创建消息卡片，参见[管理消息模板](0766-manage-message-templates.md)介绍。 |
...
| robotCode | String | 否 | 机器人编码，参见[机器人名词表-robotCode](0699-development-robot-overview.md)内容，获取`robotCode`。 |
