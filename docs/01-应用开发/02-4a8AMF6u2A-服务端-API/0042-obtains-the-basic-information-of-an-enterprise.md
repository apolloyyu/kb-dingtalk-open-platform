...
| signature | String | 是 | xxx | 签名。签名计算方式请参考[第三方访问接口的签名计算方法](1430-the-signature-calculation-method-of-the-third-party-access-interface.md)。  **[!NOTE]**  计算出签名以后，需要进行urlencode，才能把签名参数拼接到url中。 |
