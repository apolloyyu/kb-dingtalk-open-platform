...
archived: false
method: POST
endpoint: https://api.dingtalk.com/v1.0/calendar/users/{userId}/calendars/{calendarId}/events/{eventId}/attendees/batchRemove
api_version: v2-new
app_types: 第三方个人应用
...
## Path params
- userId (String, required): 日程创建者unionId。 - 企业内部应用和第三方企业应用，调用查询用户详情接口获取unionid参数值。 - 第三方个人应用，调用获取用户通讯录个人信息接口获取unionId参数值。
...
## Body
- optional: attendeesToRemove(Array), id(String)
