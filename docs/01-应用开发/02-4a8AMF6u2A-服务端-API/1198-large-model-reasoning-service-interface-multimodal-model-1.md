---
title: "大模型推理服务（多模态模型）"
source_url: "https://open.dingtalk.com/document/development/large-model-reasoning-service-interface-multimodal-model-1"
namespace: "development"
slug: "large-model-reasoning-service-interface-multimodal-model-1"
group: "应用开发"
tab: "服务端 API"
breadcrumb: "炼丹炉（模型服务） > 大模型推理服务（多模态模型）"
doc_id: "RGVSg6hACC"
updated_at: "2026-06-08 09:48:25"
---

> Source: https://open.dingtalk.com/document/development/large-model-reasoning-service-interface-multimodal-model-1
> Path: 应用开发 / 服务端 API / 炼丹炉（模型服务） > 大模型推理服务（多模态模型）
> Updated: 2026-06-08 09:48:25
...
| 权限要求 | permission-AIPaaS.Model.Read-【敏感】大模型读权限 |

### **请求头**

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | 是 | 调用该接口的访问凭证，通过以下获取：   - 企业内部应用，调用[获取企业内部应用的accessToken](0032-obtain-the-access-token-of-an-internal-app.md)接口获取。 - 第三方企业应用，调用[获取企业accessToken(应用商店应用)](0033-obtain-the-access-token-of-the-authorized-enterprise-1.md)接口获取。 |
         ...
         },
         {
             ...
             "content": [
              ...
              },
              {
                "type": "image_url",
                "image_url": {
                  "url": "https://img.alicdn.com/imgextra/i1/O1CN01G2uPLP1nlardGovhd_!!6000000005130-0-tps-370-271.jpg"
                }
              }
            ],
            "temperature" : 0.6,
