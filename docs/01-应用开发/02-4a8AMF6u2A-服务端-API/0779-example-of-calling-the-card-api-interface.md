...
下面是三个常用场域的创建并投放卡片（发送卡片）接口调用传参示例，示例中花括号的内容需要替换成真实的数据，比如 access\_token、卡片模板 id、用户 userId、群聊 openConversationId 等。[创建卡片](0781-interface-for-creating-a-card-instance.md)和[投放卡片](0782-delivery-card-interface.md)接口的传参也可参考该示例。
...
- [创建并投放卡片](0784-create-and-deliver-cards.md)
