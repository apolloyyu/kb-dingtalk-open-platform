...
doc_id: "u8dpwW1WyI"
updated_at: "2026-09-01 09:17:14"
---

> Source: https://open.dingtalk.com/document/development/delete-local-cache-files
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 文件管理器 > 删除本地缓存文件
> Updated: 2026-09-01 09:17:14
...
- 调用本接口，可删除调用[保存文件](0675-save-file.md)接口保存到本地缓存的文件。
- 本地用户文件，请调用[删除本地用户文件](0682-delete-objects-local.md)接口进行删除操作。
