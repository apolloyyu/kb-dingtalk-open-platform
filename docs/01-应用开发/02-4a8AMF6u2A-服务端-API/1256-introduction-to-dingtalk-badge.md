...
- 相关接口：
  ...
  - [解码钉工牌电子码](1261-stack-dingtalk-badge.md)
  - [通知支付结果](1262-sync-dingtalk-badge-code-payment-result.md)
  - [通知退款结果](1263-notification-dingtalk-badge-code-refund-result.md)
...
- 相关接口：
  ...
  - [创建钉工牌电子码](1259-create-a-badge-user-instance.md)
  - [解码钉工牌电子码](1261-stack-dingtalk-badge.md)
  - [同步钉工牌码验证结果](1265-notification-dingtalk-badge-verification-result.md)
...
- 相关接口：
  ...
  - [解码钉工牌电子码](1268-decoding-dingtalk-payment-code.md)
  - [创建钉工牌电子码](1266-create-a-user-code-instance.md)
  - [更新钉工牌电子码](1267-update-user-code-instance.md)
...
| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [创建钉工牌电子码](1259-create-a-badge-user-instance.md) | 调用本接口为用户创建钉工牌电子码实例，主要用于访客、会展等临时证场景。 | 新版 |
| [更新钉工牌电子码](1260-update-dingtalk-user-instance.md) | 调用本接口更新用户钉工牌码的相关信息。 | 新版 |
| [解码钉工牌电子码](1261-stack-dingtalk-badge.md) | 用本接口解码钉工牌码，获取关联的企业、用户userid等信息。 | 新版 |
| [通知支付结果](1262-sync-dingtalk-badge-code-payment-result.md) | 用户使用钉工牌码扫码支付完成后，可调用本接口同步支付结果，并通知用户完成消费，同时为用户记录账单。 | 新版 |
| [通知退款结果](1263-notification-dingtalk-badge-code-refund-result.md) | 用户使用钉工牌码支付后，如果发生退款，退款完成后，调用本接口同步退款结果，生成对应账单。 | 新版 |
| [同步钉工牌码验证结果](1265-notification-dingtalk-badge-verification-result.md) | 用户使用钉工牌码进行身份验证后，可调用本接口通知身份验证结果。 | 新版 |
| [配置企业钉工牌](1258-save-dingtalk-enterprise-instance.md) | 调用本接口为企业企业开通钉工牌电子码。 | 新版 |
| [钉工牌通知消息](1264-dingtalk-badge-notification-message.md) | 调用本接口，可用于在企业钉工牌页面，发送企业针对员工的通知消息。 | 新版 |
| [创建钉工牌电子码](1266-create-a-user-code-instance.md) | 调用本接口为用户创建钉工牌电子码实例，主要用于访客、会展等临时证场景。 | 新版 |
| [更新钉工牌电子码](1267-update-user-code-instance.md) | 调用本接口更新用户钉工牌码的相关信息。 | 新版 |
| [解码钉工牌电子码](1268-decoding-dingtalk-payment-code.md) | 用本接口解码钉工牌码，获取关联的企业、用户userid等信息。 | 新版 |
| [通知支付结果](1269-notify-dingtalk-payment-code-payment-result.md) | 户使用钉工牌码扫码支付完成后，可调用本接口同步支付结果，并通知用户完成消费，同时为用户记录账单。 | 新版 |
| [通知退款结果](1270-dingtalk-payment-code-refund-information-synchronization-operation.md) | 用户使用钉工牌码支付后，如果发生退款，退款完成后，调用本接口同步退款结果，生成对应账单。 | 新版 |
| [同步钉工牌码验证结果](1271-sync-pin-badge-code-verification-result.md) | 用户使用钉工牌码进行身份验证后，可调用本接口通知身份验证结果。 | 新版 |
| [配置企业钉工牌](1272-set-up-enterprise-payment-code-configuration-interface.md) | 调用本接口为企业企业开通钉工牌电子码。 | 新版 |
...
- [钉工牌实现用户访客码创建](1257-nail-badge-for-identity-verification.md)
