...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 文档/文件 > 知识库 > 知识库目录树管理 > 查询知识库节点信息
...
> - 未接入的开发者建议使用新版[获取节点](0569-get-knowledge-base-acquisition-node.md)接口，已接入用户不受影响。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| spaceId | String | 是 | 知识库ID，调用[新建知识库](1583-create-a-team-space.md)接口或者[查询用户有权限的知识库列表](1585-querying-the-list-of-user-team-spaces.md)接口获取的workspaceId字段值。 |
| dentryId | String | 是 | 节点ID，调用[查询知识库下的目录结构](1590-query-the-directory-tree-in-the-knowledge-base.md)接口获取DentryModel参数值。 |

## Query参数

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| operatorId | String | 是 | 操作人unionId，调用[查询用户详情](0055-query-user-details.md)接口获取。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
|  | DentryVO | 节点信息，参考[通用数据格式-DentryVO](0573-common-data-structure.md#DentryVO)。 |
