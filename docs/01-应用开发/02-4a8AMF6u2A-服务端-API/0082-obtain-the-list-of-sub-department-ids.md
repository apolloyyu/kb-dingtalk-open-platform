...
> Path: 应用开发 / 服务端 API / 通讯录管理 > 部门管理 > 获取子部门ID列表
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| dept\_id | Number | 是 | 1 | 父部门ID，根部门传1，可调用[获取部门列表](0081-user-management-acquires-the-list-departments.md)接口获取dept\_id参数值。 |
