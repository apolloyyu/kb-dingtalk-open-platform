...
doc_id: "Q4UdwwCXPq"
updated_at: "2026-06-23 18:10:42"
---
...
当前接口已完成升级迭代且不再支持新应用申请，存量应用调用不受影响，建议未接入的开发者使用[获取发起签署任务的地址](1089-obtain-the-address-used-to-initiate-a-signed-task.md)接口，已接入的开发者结合实际尽快完成迁移。
