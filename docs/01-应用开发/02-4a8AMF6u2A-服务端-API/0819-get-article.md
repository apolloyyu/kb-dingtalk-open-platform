...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| unionid | String | 是 | ftO2dFpz1zAiE | 服务号的unionid，可通过[查询服务号列表](0813-query-service-number-list.md)接口获取。 |
| article\_id | Number | 是 | 114001 | 文章id，可以通过[查询文章列表](0818-query-the-article-list.md)接口获取。 |
