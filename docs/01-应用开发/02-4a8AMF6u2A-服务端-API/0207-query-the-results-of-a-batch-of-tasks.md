...
> Path: 应用开发 / 服务端 API / 考勤 > 考勤排班 > 查询排班打卡结果
...
| schedule\_ids | String | 是 | 144872188723,144872188722 | 排班ID，通过[查询企业考勤排班详情](0208-interface-for-daily-full-query-of-attendance-scheduling-information.md)接口获取plan\_id参数值。多个排班ID之间用逗号分割，每次调用最多支持100个排班ID， |
