...
doc_id: "4QLymify0F"
updated_at: "2026-09-01 09:16:49"
---

> Source: https://open.dingtalk.com/document/development/dd-connectbledevice
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 设备 > 蓝牙 > 查找设备并连接
> Updated: 2026-09-01 09:16:49
...
| 参数 | 类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| deviceId | String | 是 | 蓝牙设备ID，可通过[获取所有已发现的蓝牙设备](0626-dd-getbluetoothdevices.md)或[监听发现新设备事件](0614-dd-onbluetoothdevicefound.md)接口中获取。 |
