...
doc_id: "ljZXkVdRWD"
updated_at: "2026-07-21 09:26:27"
---

> Source: https://open.dingtalk.com/document/development/open-approval-details
> Path: 应用开发 / 服务端 API / 更多开放 > AppLink协议 > 已支持的协议 > 打开审批详情
> Updated: 2026-07-21 09:26:27
...
| instanceId | String | 是 | PROC-\*\*\*\*-\*\*\*\*- | 实例 ID，可根据 OpenAPI [发起审批实例](0496-create-an-approval-instance.md)获取/通过[审批事件订阅](../04-LFcRvVD08N-事件订阅/0039-event-bpms-instance-change.md)获取。 |
