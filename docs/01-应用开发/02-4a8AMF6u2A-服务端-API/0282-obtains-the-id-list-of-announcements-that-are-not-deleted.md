...
| category\_id | String | 否 | 9i9u7y7g6t65 | 分类ID，可以通过[获取公告分类列表](0283-obtains-the-list-of-categories-not-deleted-for-enterprise-announcements.md)接口获取id参数值。 |
