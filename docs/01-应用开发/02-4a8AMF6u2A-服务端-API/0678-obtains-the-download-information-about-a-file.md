...
> Path: 应用开发 / 服务端 API / 文档/文件 > 存储管理 > 文件传输 > 获取文件下载信息
> Updated: 2026-06-08 12:02:08
...
| dentryId | String | 是 | 文件Id，调用[获取文件或文件夹列表](0665-get-a-list-of-files-or-folders.md)或[根据 dentryUuid 获取 spaceId](0672-api-getdentryidbyuuid.md)接口获取id参数值。 |
