...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > e签宝 1.0 > 套餐 > 套餐转售（底价结算模式）
> Updated: 2026-08-25 09:37:28
...
> - 未接入的开发者建议使用新版[套餐转售—底价结算模式](1072-package-resale-2-reserve-price-settlement-mode.md)接口，已接入用户不受影响。
