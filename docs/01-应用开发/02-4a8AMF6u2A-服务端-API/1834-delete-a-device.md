...
doc_id: "mfjVeRn1sq"
updated_at: "2026-08-27 14:20:28"
---

> Source: https://open.dingtalk.com/document/development/delete-a-device
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 钉钉物联 > 删除设备
> Updated: 2026-08-27 14:20:28
...
| deviceIds | Array of String | 是 | 外部设备ID列表，最多500条，调用[注册设备](1831-register-devices.md)或者[批量注册设备](1832-batchregister-devices.md)接口获取。 |
