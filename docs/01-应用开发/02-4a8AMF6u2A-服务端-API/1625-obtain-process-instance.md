...
doc_id: "oBxG2uoVy1"
updated_at: "2026-08-25 09:39:23"
---

> Source: https://open.dingtalk.com/document/development/obtain-process-instance
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 宜搭 > 流程 > 获取流程实例
> Updated: 2026-08-25 09:39:23
...
> - 未接入的开发者建议使用新版[获取流程实例](0306-api-getinstances-v2.md)接口，已接入用户不受影响。
