...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| agentid | Number | 是 | 123456 | 应用的AgentID。   - 企业内部应用，可在[开发者后台](https://open-dev.dingtalk.com/#/corpeapp)的应用详情页获取应用ID。image - 第三方企业应用，通过[获取企业授权信息](0041-obtains-the-basic-information-of-an-enterprise.md)接口获取agentid参数值。 |
