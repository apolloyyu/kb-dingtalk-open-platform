...
> Path: 应用开发 / 服务端 API / 宜搭 > 表单 > 批量更新表单实例内的组件值
> Updated: 2026-06-03 10:11:49
...
| updateFormDataJson | String | 是 | 用于更新表单实例的数据，格式参考[创建或更新表单数据格式说明](0366-instructions-for-creating-or-updating-form-data-format.md)。 |
...
| formInstanceIdList | Array of String | 是 | 表单实例Id，调用[获取实例ID列表](0309-api-getinstanceidlist-v2.md)接口或者[获取多个表单实例ID](0323-api-searchformdataidlist-v2.md)接口获取。 |
