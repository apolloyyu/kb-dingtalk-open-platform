...
> Path: 应用开发 / 服务端 API / 即时通信 > 消息通知 > 工作通知 > 消息通知类型
...
| media\_id | String | 是 | @lADOADmaWMzazQKA | 媒体文件mediaid，调用[上传媒体文件](0645-upload-media-files.md)接口获取mediaId参数值。建议宽600像素 x 400像素，宽高比3 : 2。 |
...
| media\_id | String | 是 | @lADOADmaWMzazQKA | 媒体文件ID，调用[上传媒体文件](0645-upload-media-files.md)接口获取。 |
...
| media\_id | String | 是 | @lADOADmaWMzazQKA | 媒体文件ID，引用的媒体文件最大10MB，可调用[上传媒体文件](0645-upload-media-files.md)接口获取。 |
...
| link.picUrl | String | 是 | @lADOADmaWMzazQKA | 调用[上传媒体文件](0645-upload-media-files.md)接口获取。 |
...
| oa.body.image | String | 否 | @lADOADmaWMzazQKA | 消息体中的图片，支持图片资源@mediaId，通过调用[上传媒体文件](0645-upload-media-files.md)接口获取，建议宽600像素 x 400像素，宽高比3 : 2。 |
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| msgtype | String | 是 | markdown | 消息类型，通过调用[上传媒体文件](0645-upload-media-files.md)接口获取，Markdown类型为：markdown。 |
...
| action\_card.single\_url | String | 否 | https://open.dingtalk.com | 消息点击链接地址，调用[上传媒体文件](0645-upload-media-files.md)接口获取，当发送消息为小程序时支持小程序跳转链接，最长500个字符。 |
