...
> Path: 应用开发 / 服务端 API / 宜搭 > 任务 > 批量查询宜搭表单实例的评论
...
| formInstanceIdList | Array of String | 否 | 宜搭表单实例Id，调用[获取实例ID列表](0309-api-getinstanceidlist-v2.md)接口或者[获取多个表单实例ID](0323-api-searchformdataidlist-v2.md)接口获取。 |
