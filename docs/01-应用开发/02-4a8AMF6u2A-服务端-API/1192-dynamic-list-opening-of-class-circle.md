...
| student\_id | String | 否 | stu123 | 学生的userId，可调用[获取人员列表](1154-obtains-a-list-of-home-school-user-identities.md)接口获取userid参数值。 |
| class\_id | Number | 否 | 26347 | 班级ID，可调用[获取部门列表](1153-obtains-the-department-node-list.md)接口获取dept\_id参数值。 |
| topic\_id | Number | 否 | 19827347 | 话题ID，可调用[获取班级圈话题列表](1191-obtain-a-topic-list-of-class-circles.md)接口获取topic\_id参数值。 |
