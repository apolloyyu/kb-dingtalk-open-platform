...
> - 未接入的开发者建议使用新版[修改日程](0251-modify-event.md)接口，已接入用户不受影响。

> **[!NOTE]**
>
> 本接口使用说明：
>
> - 只能修改通过[创建日程](1537-schedule-2-0-creation-interface.md)接口创建的日程。
> - 确保已经申请了[修改日程参与者](1539-schedule-2-0-participant-modification.md)接口权限。
