...
> Path: 应用开发 / 服务端 API / 即时通信 > 会话管理 > 场景群 > 群管理 > 查询场景群基本信息
...
支持场景：基于群模板创建的群，详情参见[创建群](1487-create-a-scene-group-v2.md)。
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| open\_conversation\_id | String | 是 | cid9FTRQSLo+s\*\*\*\*\*== | 群ID，调用[创建场景群](0747-create-a-scene-group.md)接口获取`open_conversation_id`参数值。 |
