...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 待办任务 > 更新钉钉待办任务
...
> - 未接入的开发者建议使用新版[更新钉钉待办任务](0797-updates-dingtalk-to-do-tasks.md)接口，已接入用户不受影响。
...
| record\_id | String | 是 | recordfcf7403667fcd9 | 待办任务唯一ID，可使用[新增钉钉待办任务](1553-new-to-do-items.md)中传入的biz\_id，也可以使用返回中的record\_id。 |
