...
doc_id: "3CAg3nHy6a"
updated_at: "2026-08-25 09:39:28"
---

> Source: https://open.dingtalk.com/document/development/save-form-data
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 宜搭 > 表单 > 保存表单数据
> Updated: 2026-08-25 09:39:28
...
> - 未接入的开发者建议使用新版[保存表单数据](0315-api-saveformdata-v2.md)接口，已接入用户不受影响。
