...
> Path: 应用开发 / 服务端 API / 更多开放 > 视听智能服务 > 分页获取企业下的服务记录信息
...
| teamCode | String | 否 | 团队编码，可通过[分页查询客户列表](1297-api-listcustomer.md)接口获取。 |
| customerId | String | 否 | 服务客户的客户ID，可通过[分页查询客户列表](1297-api-listcustomer.md)接口获取。 |
