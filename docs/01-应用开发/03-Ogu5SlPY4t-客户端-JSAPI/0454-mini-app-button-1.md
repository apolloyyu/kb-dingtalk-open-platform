...
doc_id: "7ISpKGThjh"
updated_at: "2026-09-01 09:16:27"
---

> Source: https://open.dingtalk.com/document/development/mini-app-button-1
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 基础组件 > 表单 > button 按钮
> Updated: 2026-09-01 09:16:27
...
| **值** | **说明** |
| --- | --- |
| share | 触发自定义分享，可使用[dd.canIUse](0476-dd-caniuse.md)判断。 |
