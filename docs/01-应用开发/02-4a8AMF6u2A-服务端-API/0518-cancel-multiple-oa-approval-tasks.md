...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| processInstanceId | String | 是 | OA审批流程实例ID，调用[创建实例](0512-create-a-ticket-approval-instance.md)接口获取processInstanceId参数值。 |
...
| activityIds | Array of String | 否 | 待办组ID列表，调用[创建流程中心待处理任务](0515-create-pending-tasks-in-process-center.md)接口获取。 |
