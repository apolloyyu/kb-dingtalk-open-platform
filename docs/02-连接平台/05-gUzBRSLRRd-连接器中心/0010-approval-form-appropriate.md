...
3. 拥有一个所在组织的[宜搭应用](../../01-应用开发/02-4a8AMF6u2A-服务端-API/0367-yida-faq.md#7b1f6070ebwcc)。
...
- 如果无宜搭数据表单，详情参见[如何创建流程表单？](../../01-应用开发/02-4a8AMF6u2A-服务端-API/0367-yida-faq.md#fc88b0c0ebdtm)。
