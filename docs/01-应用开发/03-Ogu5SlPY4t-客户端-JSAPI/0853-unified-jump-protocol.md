...
- **链接如何在PC端侧边栏或在工作台中打开？**
  ...
  - **在PC端侧边栏打开**：加上`pc_slide=true`后缀，如`dingtalk://dingtalkclient/page/link?url=https%3A%2F%2Fwww.dingtalk.com&pc_slide=true`。此外，在H5微应用中，也可以通过[打开侧边面板](0836-open-side-panel.md)来实现。
