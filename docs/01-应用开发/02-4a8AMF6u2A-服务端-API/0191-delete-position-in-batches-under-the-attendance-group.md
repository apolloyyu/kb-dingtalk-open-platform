...
> Path: 应用开发 / 服务端 API / 考勤 > 考勤组管理 > 批量删除地点
...
| group\_key | String | 是 | CEDDFxxxx | 考勤组ID。  **[!NOTE]**  如果你使用的考勤组标识是group\_id，可以调用[groupId转换为groupKey](0176-groupid-to-groupkey.md)接口将group\_id转换为group\_key。 |
| position\_key\_list | String | 是 | C384Fxxxx | 要删除position的key列表，可通过[批量查询地点](0192-batch-query-position-under-attendance-group.md)接口获取，每次最多支持删除100个地点信息。 |
