...
archived: false
method: POST
endpoint: https://api.dingtalk.com/v1.0/doc/workbooks/{workbookId}/sheets/{sheetId}/deleteRows
api_version: v2-new
app_types: 第三方企业应用
...
## Body
- row (Long, required): 要删除的第一行的游标，从0开始。
- rowCount (Long, required): 要删除的行的数量。
