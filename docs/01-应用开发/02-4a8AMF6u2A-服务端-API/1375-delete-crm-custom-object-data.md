...
> Path: 应用开发 / 服务端 API / 更多开放 > 客户管理（官方CRM） > 自定义对象 > 删除CRM自定义对象数据
> Updated: 2026-06-04 19:12:15
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| instanceId | String | 是 | CRM自定义对象数据ID，可通过[根据指定条件查询自定义对象数据](1378-api-getobjectdata.md)接口获取instance\_id参数值。 |
