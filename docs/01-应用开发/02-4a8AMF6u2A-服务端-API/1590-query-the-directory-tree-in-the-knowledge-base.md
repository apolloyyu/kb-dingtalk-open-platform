...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 文档/文件 > 知识库 > 知识库目录树管理 > 查询知识库下的目录结构
...
> - 未接入的开发者建议使用新版[获取节点列表](0570-get-node-list.md)接口，已接入用户不受影响。
...
| operatorId | String | 是 | 当前操作用户的unionId，调用[查询用户详情](0055-query-user-details.md)接口获取。 |
...
| DentryModel | DentryModel | 节点信息，参考[通用数据格式-DentryVO](0573-common-data-structure.md#DentryVO)。 |
