...
> Path: 应用开发 / 服务端 API / 文档/文件 > 知识库 > 知识库目录树管理 > 获取节点列表
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| parentNodeId | String | 是 | 父节点id(父节点dentryUuid)，可通过调用[获取知识库列表](0559-get-knowledge-base-list.md)接口，获取返回参数`rootNodeId`字段。 |
