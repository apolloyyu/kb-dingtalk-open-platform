...
| media\_id | String | 是 | P16mHftLYX8iE | 图文卡片素材id，可以通过[查询图文卡片列表](0825-query-message-card-list.md)接口获取。 |
| articles | ArticleDTO[] | 否 |  | 文章列表。 |
| article\_id | Number | 否 | 10001 | 文章id，可以通过[查询文章列表](0818-query-the-article-list.md)接口获取。 |
