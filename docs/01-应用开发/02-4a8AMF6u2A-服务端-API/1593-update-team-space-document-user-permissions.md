...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 文档/文件 > 知识库 > 知识库文档权限管理 > 修改知识库文档成员权限
...
| memberId | String | 是 | 被更新的文档成员。   - memberType如果是**USER**，该参数值传员工的unionId，调用[查询用户详情](0055-query-user-details.md)接口获取。 - memberType如果是**DEPT**，该参数值是传部门ID，调用[获取部门列表](0081-user-management-acquires-the-list-departments.md)接口获取。 |
