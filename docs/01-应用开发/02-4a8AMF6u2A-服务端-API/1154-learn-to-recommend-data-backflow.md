...
> Path: 应用开发 / 服务端 API / 行业与生态 > 行业开放 > 新教育 > 家庭 > 学习推荐数据回流
...
| subject\_code | String | 否 | cn\_p\_shuxue | 学段编码，可通过[获取学段元数据列表](1129-dingtalk-the-main-data-of-the-education-ecosystem-to-query.md)接口获取period\_code参数值。 |
