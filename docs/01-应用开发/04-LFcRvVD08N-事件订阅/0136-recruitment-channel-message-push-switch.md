...
doc_id: "d45RKGOO1b"
updated_at: "2025-08-28 19:46:59"
---
...
- `data.userId`（string）：员工标识
- `data.channelAccountId`（string）：渠道账号标识
- `data.outId`（string）：外部标识
- `data.pushAction`（string）：推送action
- `data.pluginCode`（string）：接收事件的插件code
...
- `biz_data.userId`（string）：员工标识
- `biz_data.channelAccountId`（string）：渠道账号标识
- `biz_data.outId`（string）：外部标识
- `biz_data.pushAction`（string）：推送action
- `biz_data.pluginCode`（string）：接收事件的插件code
