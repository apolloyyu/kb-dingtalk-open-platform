...
> Path: 应用开发 / 服务端 API / 日程 > 忙闲 > 获取用户忙闲信息
> Updated: 2026-06-02 09:25:06
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| userId | String | 是 | 本次请求的资源所归属的用户unionId。   - 企业内部应用和第三方企业应用，调用[查询用户详情](0055-query-user-details.md)接口获取unionid参数值。 - 第三方个人应用，调用[获取用户通讯录个人信息](0053-dingtalk-retrieve-user-information.md)接口获取unionId参数值。 |

### 请求体

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| userIds | Array of String | 是 | 查询目标用户的unionId。   - 企业内部应用和第三方企业应用，调用[查询用户详情](0055-query-user-details.md)接口获取unionid参数值。 - 第三方个人应用，调用[获取用户通讯录个人信息](0053-dingtalk-retrieve-user-information.md)接口获取unionId参数值。       用户列表最大长度 20。 |
