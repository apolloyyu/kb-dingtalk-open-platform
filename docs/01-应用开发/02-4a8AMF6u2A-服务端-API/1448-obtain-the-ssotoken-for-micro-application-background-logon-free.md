...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 获取访问凭证 > 获取微应用后台免登的access_token
...
> - 未接入的开发者建议使用新版 [获取微应用后台免登的accessToken](0024-obtain-the-access-token-of-the-micro-application-background-without-log-on.md)接口，已接入用户不受影响。
