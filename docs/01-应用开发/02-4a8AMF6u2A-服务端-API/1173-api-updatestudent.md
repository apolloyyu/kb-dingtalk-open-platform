...
> Path: 应用开发 / 服务端 API / 行业与生态 > 行业开放 > 新教育 > 家校通讯录2.0 > 更新学生
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| userId | String | 是 | 学生ID，可调用[获取人员列表](1158-obtains-a-list-of-home-school-user-identities.md)接口获取userid参数值。 |
...
| studentNo | String | 是 | 学生学号，可调用[获取人员列表](1158-obtains-a-list-of-home-school-user-identities.md)接口获取student\_no参数值。 |
