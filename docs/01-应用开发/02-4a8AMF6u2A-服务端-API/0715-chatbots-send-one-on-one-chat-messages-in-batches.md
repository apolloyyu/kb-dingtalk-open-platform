...
> Path: 应用开发 / 服务端 API / 即时通信 > 机器人 > 发送普通消息 > 批量发送人与机器人会话中机器人消息
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| robotCode | String | 是 | 机器人的编码，该参数必须使用企业内部应用机器人的robotCode，详情参考[机器人 ID](0699-development-robot-overview.md#447ec33014hrl)。 |
...
| msgParam | String | 是 | 消息模板参数，消息模板参数，详情参考[消息发送与接收类型](0700-robot-message-type.md)。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| processQueryKey | String | 消息id，可用于[批量查询人与机器人会话机器人消息是否已读](0721-chatbot-batch-query-the-read-status-of-messages.md)和[批量撤回人与机器人会话中机器人消息](0724-batch-message-recall-chat.md)接口，查询消息是否已读和撤回消息。 |
