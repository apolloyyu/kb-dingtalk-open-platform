...
3. 根据 authCode，调用服务端[获取用户token](0031-obtain-user-token.md)接口，获取用户个人token。
4. 根据用户个人token，调用[获取用户通讯录个人信息](0053-dingtalk-retrieve-user-information.md)接口，获取授权用户个人信息。
