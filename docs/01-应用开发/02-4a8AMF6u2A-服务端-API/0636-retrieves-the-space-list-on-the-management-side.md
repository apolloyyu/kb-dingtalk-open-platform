...
> Path: 应用开发 / 服务端 API / 文档/文件 > 云盘（原钉盘） > 根据spaceId获取指定空间信息
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| spaceIds | Array of String | 是 | 空间ID列表，最多允许传入30个，可调用[获取空间列表](0635-queries-a-space-list.md)接口获取。 |
| unionId | String | 是 | 用户unionId，可调用[查询用户详情](0055-query-user-details.md)接口获取。 |
