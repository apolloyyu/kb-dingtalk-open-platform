...
> - 未接入的开发者建议使用新版[删除部门](0078-address-book-deletion-department.md)接口，已接入用户不受影响。
...
| id | String | 是 | 123 | 部门ID，可调用[获取部门列表](1466-obtain-the-department-list.md)接口获取。  **[!NOTE]**  以下情况无法删除部门：   - 不能删除根部门，即部门ID为1。 - 部门或子部门内还有未删除的员工。 |
