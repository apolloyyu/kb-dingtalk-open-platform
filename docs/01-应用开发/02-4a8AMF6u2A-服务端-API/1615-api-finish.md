...
开发者可以通过钉钉 AI 助理主动给用户发送自定义智能消息。主动发送的步骤可以分为：[预备](1613-api-prepare.md)、[更新](1614-the-ai-assistant-updates-active-message-sending-mode.md)和[结束](#)三步。本文档介绍的接口是结束接口，该接口能结束消息框的更新。
