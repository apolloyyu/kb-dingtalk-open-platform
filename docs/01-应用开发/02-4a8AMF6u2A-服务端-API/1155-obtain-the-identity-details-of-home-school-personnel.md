...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| class\_id | Number | 是 | 389206748 | 班级ID，可调用[获取部门列表](1153-obtains-the-department-node-list.md)接口获取dept\_type为class时的dept\_id参数值。 |
| role | String | 是 | student | 家校人员角色。   - **teacher**：老师 - **guardian**：监护人 - **student**：学生 |
| userid | String | 是 | 1020302901 | 人员userId，可调用[获取人员列表](1154-obtains-a-list-of-home-school-user-identities.md)接口获取userid参数值。 |
