...
| **API** | **API说明** | **API 版本** |
| --- | --- | --- |
| [创建公告](0278-create-an-enterprise-announcement.md) | 创建企业公告。 | 旧版 |
| [删除公告](0279-delete-announcements-based-on-the-announcement-id.md) | 根据公告ID删除公告。 | 旧版 |
| [更新公告](0280-modify-the-announcement-according-to-the-announcement-id.md) | 更新公告。 | 旧版 |
| [获取公告详情](0281-obtains-the-details-get-blackboard.md) | 根据公告ID获取未删除的公告的详情。 | 新版 |
| [获取公告ID列表](0282-obtains-the-id-list-of-announcements-that-are-not-deleted.md) | 获取企业某公告分类下所有未删除公告的ID列表。 | 旧版 |
| [获取公告分类列表](0283-obtains-the-list-of-categories-not-deleted-for-enterprise-announcements.md) | 获取未删除的公告分类列表。 | 旧版 |
| [获取用户可查看的公告](0284-list-the-user-s-announcement-list.md) | 获取指定人员的公告信息，在企业自定义工作首页进行公告轮播展示。 | 旧版 |
| [获取公告钉盘空间信息](0285-obtain-bulletin-nail-disk-space-information.md) | 获取企业组织公告的钉盘空间信息。 | 新版 |
| [查询公告已读未读人员列表](0286-query-bulletin-read-unread-persons-list.md) | 获取指定公告的已读未读人员列表。 | 新版 |
...
钉钉提供了公告接口接入流程示例，请参见[创建、获取、更新及删除公告](0277-create-and-delete-announcements.md)**。**
