...
> Path: 应用开发 / 服务端 API / 通讯录管理 > 用户管理 > 通讯录userId排序
> Updated: 2026-06-02 09:18:13
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| userIdList | Array of String | 是 | 用户userId，可通过[通过免登码获取用户信息](0023-obtain-the-userid-of-a-user-by-using-the-log-free.md)获得userid参数值。 |
