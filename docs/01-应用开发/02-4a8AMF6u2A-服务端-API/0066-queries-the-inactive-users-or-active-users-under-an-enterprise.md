...
> Path: 应用开发 / 服务端 API / 通讯录管理 > 用户管理 > 获取未登录钉钉的员工列表
...
| dept\_ids | String | 否 | 1,2,3 | 部门ID列表，可调用[获取部门列表](0081-user-management-acquires-the-list-departments.md)获取，不传表示查询整个企业。 |
