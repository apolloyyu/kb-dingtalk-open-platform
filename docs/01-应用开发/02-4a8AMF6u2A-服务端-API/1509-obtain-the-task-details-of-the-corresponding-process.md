...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > e签宝 1.0 > 签署流程 > 获取流程任务详情
> Updated: 2026-08-25 09:37:37
...
> - 未接入的开发者建议使用新版[获取流程的签署详情](1085-get-the-details-of-process-signing.md)接口，已接入用户不受影响。
