...
doc_id: "nCWiuYfDL4"
updated_at: "2026-09-01 09:16:59"
---

> Source: https://open.dingtalk.com/document/development/listen-for-events-that-occur-when-the-mini-program-is
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 应用级事件 > 监听小程序切前台事件
> Updated: 2026-09-01 09:16:59
...
> - 该事件与App.js内声明的[app.js注册小程序](0434-app-js-registration-mini-program-1.md)**onShow**方法的回调时机一致。
...
| 属性 | 类型 | 描述 |
| --- | --- | --- |
| callback | Function | 小程序切前台事件的回调函数。回调函数的参数请参考框架[app.js注册小程序](0434-app-js-registration-mini-program-1.md)**onShow**的回调参数。 |
