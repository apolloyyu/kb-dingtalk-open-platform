...
doc_id: "aGAZmf4xLx"
updated_at: "2026-08-27 14:20:13"
---

> Source: https://open.dingtalk.com/document/development/batch-modify-devices
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 钉钉物联 > 批量修改设备
> Updated: 2026-08-27 14:20:13
...
| deviceId | String | 是 | 外部设备ID，调用[注册设备](1831-register-devices.md)或者[批量注册设备](1832-batchregister-devices.md)接口获取。 |
...
| extraData | Map | 否 | 扩展数据，该参数需线下提供，请通过对接群进行咨询。 |
