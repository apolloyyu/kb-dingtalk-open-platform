...
文件或文件夹添加事件数据。如果仅在开发者后台开启存储事件订阅开关，无法接收回调事件，必须与接口配合使用，接口详情参见[订阅文件变更事件](../02-4a8AMF6u2A-服务端-API/0696-subscribe-to-file-change-events.md)。
