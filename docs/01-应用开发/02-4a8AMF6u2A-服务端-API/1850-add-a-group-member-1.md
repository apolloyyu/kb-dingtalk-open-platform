...
doc_id: "M82r7UxzOs"
updated_at: "2026-08-27 14:23:44"
---

> Source: https://open.dingtalk.com/document/development/add-a-group-member-1
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 钉钉客联 > 添加钉钉客联互通群成员
> Updated: 2026-08-27 14:23:44
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| openConversationId | String | 是 | 会话openConversationId，可调用[创建钉钉客联普通互通群](1845-create-common-group-new-version.md) / [创建钉钉客联两人互通群](1846-creating-two-groups-of-people.md)接口获取，长度限制为1～32个字符。 |
| appUserIds | Array of String | 否 | 钉外账号在业务系统内的唯一标志，调用[创建钉钉客联钉外账号](1844-create-bc-account-association.md)接口获取，长度限制为1～64个字符。 |
| userIds | Array of String | 否 | 钉内账号userId，长度限制为1～64个字符。  **[!NOTE]**  钉内账号和钉外账号总和不超过30个。 |
