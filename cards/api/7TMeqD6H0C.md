...
## Returns
- optional: request_id(String), errcode(Number), errmsg(String), result(Object), userid(String), unionid(String), name(String), avatar(String), state_code(String), mobile(String), hide_mobile(Boolean), telephone(String), job_number(String), title(String), email(String), org_email(String), work_place(String), remark(String), dept_id_list(Number[]), dept_order_list(Object[]), dept_id(Number), order(Number), extension(String), hired_date(Number), active(Boolean), real_authed(Boolean), senior(Boolean), admin(Boolean), boss(Boolean), leader_in_dept(Object[]), leader(Boolean), role_list(Object[]), id(Number), group_name(String), exclusive_account(Boolean), union_emp_ext(Object), union_emp_map_list(Object[]), corp_id(String), exclusive_account_type(String), login_id(String), manager_userid(String), org_email_type(String), nickname(String), exclusive_account_corp_name(String), exclusive_account_corp_id(String), disable_status(Boolean), ext_attrs(EmpExtAttr[])
