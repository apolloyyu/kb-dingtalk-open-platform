...
doc_id: "a2484O97v6"
updated_at: "2026-06-04 19:09:16"
---

> Source: https://open.dingtalk.com/document/development/clear-cell-data
> Path: 应用开发 / 服务端 API / 文档/文件 > 表格 > 单元格区域 > 清除单元格区域内数据
> Updated: 2026-06-04 19:09:16
...
| sheetId | String | 是 | 工作表的ID或标题。   - 企业内部应用，可调用[获取所有工作表](0594-obtain-all-worksheets.md)接口获取id或者传工作表的标题。 - 第三方企业应用，建议传递工作表的标题。   工作表的标题查看步骤如下图。 |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| operatorId | String | 是 | 操作人unionId，可调用[查询用户详情](0055-query-user-details.md)接口获取。 |
