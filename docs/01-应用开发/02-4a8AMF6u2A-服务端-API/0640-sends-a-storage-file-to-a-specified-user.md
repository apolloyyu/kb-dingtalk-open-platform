...
> Path: 应用开发 / 服务端 API / 文档/文件 > 群文件 > 以应用身份发送文件给指定用户
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 是 | 接收文件的用户unionId，可调用[查询用户详情](0055-query-user-details.md)接口获取。 |

### 请求体

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| spaceId | String | 是 | 文件所在空间ID，调用[添加空间](0651-add-space.md)接口获取id参数值。 |
