...
2. 拥有OA审批的管理员权限。
3. 拥有一个所在钉钉组织的[知识库](../../01-应用开发/02-4a8AMF6u2A-服务端-API/0552-knowledge-base-overview.md)。
...
1. 需提前创建[知识库和知识库目录](../../01-应用开发/02-4a8AMF6u2A-服务端-API/0552-knowledge-base-overview.md)。
2. 附件大小建议在3MB以内。
