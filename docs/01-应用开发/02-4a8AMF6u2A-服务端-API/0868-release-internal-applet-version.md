...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| appVersionId | Long | 是 | 小程序版本id，用于唯一标识小程序版本信息，可调用[获取企业内部小程序的版本列表](0870-get-the-version-list-of-the-enterprise-internal-applet.md)接口，获取返回参数中 `appVersionId` 字段值。 |
