...
> Path: 应用开发 / 服务端 API / 宜搭 > 表单 > 更新表单数据
...
| formInstanceId | String | 是 | 流程实例ID，调用[保存表单数据](0315-api-saveformdata-v2.md)接口获取。 |
...
| formUuid | String | 否 | 表单UID，当使用组件别名时必填，可通过[获取指定应用下的表单列表](0333-depending-on-the-application-id-to-get-the-form-list.md)接口获取。 |
