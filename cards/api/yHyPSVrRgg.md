...
archived: false
method: POST
endpoint: https://api.dingtalk.com/v1.0/doc/workbooks/{workbookId}/sheets/{sheetId}/conditionalFormattingRules
api_version: v2-new
app_types: 企业内部应用
...
## Body
- ranges (Array of String, required): 单元格地址，使用A1表示法。
- optional: duplicateCondition(Object), operator(String), numberCondition(Object), value1(Any), value2(Any), cellStyle(Object), backgroundColor(String), fontColor(String)
