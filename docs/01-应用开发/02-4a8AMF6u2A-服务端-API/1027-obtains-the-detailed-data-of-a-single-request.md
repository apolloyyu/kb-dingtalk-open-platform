...
| thirdpart\_apply\_id | String | 否 | abcdef | 外部审批单ID，调用[获取申请单列表](1026-search-enterprise-approval-form-data.md)接口获取。 |
| apply\_id | Number | 否 | 123 | 阿里商旅审批单ID，调用[获取申请单列表](1026-search-enterprise-approval-form-data.md)接口获取。 |
| apply\_show\_id | String | 否 | 2017651 | 阿里商旅审批单展示ID，调用[获取申请单列表](1026-search-enterprise-approval-form-data.md)接口获取。 |
