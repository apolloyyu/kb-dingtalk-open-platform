...
- `data.spiTicketModel.operatorNickName`（string）：创建人昵称。
- `data.spiTicketModel.operatorUnionId`（string）：创建人昵称。
...
- `spiTicketModel.operatorNickName`（string）：创建人昵称。
- `spiTicketModel.operatorUnionId`（string）：创建人昵称。
...
- `biz_data.spiTicketModel.operatorNickName`（string）：创建人昵称。
- `biz_data.spiTicketModel.operatorUnionId`（string）：创建人昵称。
