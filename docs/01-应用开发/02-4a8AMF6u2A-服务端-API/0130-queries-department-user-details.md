...
> Path: 应用开发 / 服务端 API / 通讯录管理 > 行业通讯录 > 获取部门用户详情
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| dept\_id | Number | 是 | 1 | 部门ID，可调用[获取部门列表](0081-user-management-acquires-the-list-departments.md)接口获取dept\_id参数值。 |
| userid | String | 是 | user01 | 员工userId，可调用[获取部门下人员列表](0129-obtains-the-list-of-people-under-a-department.md)接口获取userid参数值。 |
