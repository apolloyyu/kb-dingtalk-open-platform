...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| open\_conversation\_id | String | 是 | cid15\*\*\*\*\*== | 群ID，调用[创建群](1483-create-a-scene-group-v2.md)接口获取`open_conversation_id`参数值。 |
...
| 400020 | 没有访问权限 | 请在调用[创建群](1483-create-a-scene-group-v2.md)接口后，延迟几秒再调用本接口 |
