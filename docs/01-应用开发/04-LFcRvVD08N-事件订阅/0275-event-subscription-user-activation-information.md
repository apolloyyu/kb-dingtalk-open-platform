...
doc_id: "GH1C0r1aAm"
updated_at: "2026-09-02 18:14:41"
---
...
企业内部用户变更事件，eventType为user\_active\_org时表示用户加入企业后的激活信息，active字段为true时表示已激活，字段值来自于[通讯录事件](0343-address-book-events.md) 。
