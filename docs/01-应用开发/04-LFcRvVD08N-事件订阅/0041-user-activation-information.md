...
group: "应用开发"
tab: "事件订阅"
breadcrumb: "通讯录 > 用户管理 > 用户激活信息"
doc_id: "Vvvqy2Kndl"
updated_at: "2026-07-22 16:25:37"
---

> Source: https://open.dingtalk.com/document/development/user-activation-information
> Path: 应用开发 / 事件订阅 / 通讯录 > 用户管理 > 用户激活信息
> Updated: 2026-07-22 16:25:37
...
企业内部用户变更事件，事件英文名称为user\_active\_org时表示用户加入企业后的激活信息，active字段为true时表示已激活，字段值来自于[查询用户详情](../02-4a8AMF6u2A-服务端-API/0055-query-user-details.md)接口 。
