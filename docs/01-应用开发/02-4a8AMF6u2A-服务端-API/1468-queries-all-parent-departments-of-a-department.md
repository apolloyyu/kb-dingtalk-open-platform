...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 通讯录管理 > 部门管理1.0(不推荐) > 获取指定部门的所有父部门列表
...
> - 未接入的开发者建议使用新版[获取指定部门的所有父部门列表](0083-query-the-list-of-all-parent-departments-of-a-department.md)接口，已接入用户不受影响。
...
| id | String | 否 | 420727358 | 部门ID，可调用[获取部门列表](1466-obtain-the-department-list.md)接口获取。 |
