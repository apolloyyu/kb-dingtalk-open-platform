...
> Path: 应用开发 / 服务端 API / 更多开放 > 服务窗 > 查询服务窗粉丝用户基础信息
> Updated: 2026-06-04 19:12:03
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 是 | 需要查询关注状态信息的用户unionId，调用[获取用户基本信息](0051-queries-basic-user-information.md)接口，获取用户unionId信息。 |
