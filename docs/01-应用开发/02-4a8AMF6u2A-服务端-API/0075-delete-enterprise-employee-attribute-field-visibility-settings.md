...
> Path: 应用开发 / 服务端 API / 通讯录管理 > 用户管理 > 删除用户属性可见性设置
> Updated: 2026-06-02 09:18:10
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| settingId | Long | 是 | 设置的ID，可通过[设置用户属性可见性](0073-add-or-update-the-hidden-settings-of-the-employee-property.md)接口获取id参数值。 |
