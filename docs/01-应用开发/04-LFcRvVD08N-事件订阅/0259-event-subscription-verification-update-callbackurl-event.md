---
title: "验证和更新回调URL事件"
source_url: "https://open.dingtalk.com/document/development/event-subscription-verification-update-callbackurl-event"
namespace: "development"
slug: "event-subscription-verification-update-callbackurl-event"
group: "应用开发"
tab: "事件订阅"
breadcrumb: "历史文档（不推荐） > HTTP回调 > 通用回调事件 > 验证和更新回调URL事件"
doc_id: "21c76gWmax"
updated_at: "2025-12-08 15:34:40"
---

> Source: https://open.dingtalk.com/document/development/event-subscription-verification-update-callbackurl-event
> Path: 应用开发 / 事件订阅 / 历史文档（不推荐） > HTTP回调 > 通用回调事件 > 验证和更新回调URL事件
> Updated: 2025-12-08 15:34:40
