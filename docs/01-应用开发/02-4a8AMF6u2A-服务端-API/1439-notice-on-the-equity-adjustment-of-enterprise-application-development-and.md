...
| **OpenAPI名称** | **OpenAPI详情** |
| --- | --- |
| [添加待入职员工](0946-add-employees-to-be-hired-supports-system-and-custom-fields.md) | 在企业自有通讯录系统内，添加待入职员工时，调用本接口在钉钉智能人事应用内同步添加待入职员工 |
...
| [发送DING消息](0713-robot-sends-nail-message.md) | 企业在紧急场景下，可调用本接口给指定员工发起应用内DING消息、短信DING消息和电话DING消息提醒 |
| [撤回已经发送的DING消息](0714-robot-withdraws-pin-message.md) | 已发送的DING消息，支持调用本接口进行撤回 |
