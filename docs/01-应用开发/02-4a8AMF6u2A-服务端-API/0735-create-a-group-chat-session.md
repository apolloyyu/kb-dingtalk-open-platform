...
调用[创建场景群](0747-create-a-scene-group.md)接口创建**群聊会话**。第三方企业应用[创建场景群](0747-create-a-scene-group.md)接口前，需要设置灰度企业。
...
调用[启用群模板](0760-enable-a-group-template.md)接口，实现群升级为群聊会话。

> **[!IMPORTANT]**
>
> 调用[启用群模板](0760-enable-a-group-template.md)接口前，需要设置灰度企业。![企业灰度](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0212993871/p368591.png)
