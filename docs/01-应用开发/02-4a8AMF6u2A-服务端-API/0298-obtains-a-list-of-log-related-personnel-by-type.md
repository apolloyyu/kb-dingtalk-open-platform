...
> Path: 应用开发 / 服务端 API / 日志 > 获取日志相关人员列表
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| report\_id | String | 是 | 17469xxx | 日志ID，可通过[获取用户发送日志的概要信息](0297-view-log-summary-data.md)或[获取用户发出的日志列表](0296-query-logs-sent-by-an-employee.md)接口获取report\_id参数值。 |
