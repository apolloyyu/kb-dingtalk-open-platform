...
doc_id: "csaeo97dAX"
updated_at: "2026-09-10 14:33:17"
---

> Source: https://open.dingtalk.com/document/development/obtain-download-file-info
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 文档/文件 > 钉盘 > 文件传输 > 获取文件下载信息
> Updated: 2026-09-10 14:33:17
...
> **[!NOTE]**
>
> 获取文件下载信息，要求钉钉组织必须是已认证企业，请参考[如何完成企业认证](https://alidocs.dingtalk.com/i/p/Y7kmbokZp3pgGLq2/docs/Mk5evdR04jBV5PDYKxNeWQL3x2OlParn)。
