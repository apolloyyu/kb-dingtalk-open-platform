...
> **[!NOTE]**
>
> - [创建日程](0249-create-schedule.md)、[修改日程](0251-modify-event.md)、[添加日程参与者](0255-add-schedule-participant.md)和[删除日程参与者](0256-delete-schedule-participant.md)接口，每次日程参与者操作最大支持500人，最大支持操作5000人的日程。
> - 日程参与者的添加和删除，建议使用[添加日程参与者](0255-add-schedule-participant.md)和[删除日程参与者](0256-delete-schedule-participant.md)接口。

#### **用户访问控制**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [创建访问控制](0246-create-schedule-access-control.md) | 给指定日历添加访问控制。 | 新版 |
| [删除访问控制](0247-delete-an-access-control-list.md) | 删除访问控制。 | 新版 |
| [获取访问控制列表](0248-obtain-the-access-control-list-of-the-calendar.md) | 获取日历访问控制列表。 | 新版 |

#### **日程**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [创建日程](0249-create-schedule.md) | 创建一个日程。 | 新版 |
| [删除日程](0250-delete-event.md) | 删除指定日程。 | 新版 |
| [修改日程](0251-modify-event.md) | 修改单个日程信息。 | 新版 |
| [查询单个日程详情](0252-query-details-about-an-event.md) | 查询单个日程详情。 | 新版 |
| [查询日程列表](0253-query-an-event-list.md) | 查询一个用户给定时间范围内的日程。 | 新版 |
| [查询日程视图](0254-query-schedule-view.md) | 查询用户的钉钉主日历在某时间范围内的日程视图。 | 新版 |

#### **日程参与者**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [添加日程参与者](0255-add-schedule-participant.md) | 添加日程参与者。 | 新版 |
| [删除日程参与者](0256-delete-schedule-participant.md) | 从日程参与者中删除指定的用户。 | 新版 |
| [获取日程参与者](0258-get-the-participants-of-a-schedule.md) | 获取日程参与者列表。 | 新版 |
| [设置日程响应邀请状态](0257-configure-response-status.md) | 设置日程响应邀请状态。 | 新版 |

#### **忙闲**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [获取用户忙闲信息](0259-free-schedule.md) | 查询指定用户列表在指定时间内的忙闲信息。 | 新版 |

#### **日历**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [查询日历](0260-query-a-calendar.md) | 调用本接口查询用户日历。 | 新版 |
| [订阅公共日历](0261-subscribe-to-a-public-calendar.md) | 调用本接口订阅公共日历。 | 新版 |
| [取消订阅公共日历](0262-unsubscribe-from-a-public-calendar.md) | 调用本接口，取消订阅公共日历。 | 新版 |
| [创建订阅日历](0263-create-subscription-calendar.md) | 调用本接口创建订阅日历。 | 新版 |
| [查询单个订阅日历详情](0264-query-a-single-subscription-calendar.md) | 调用本接口查询订阅日历的详情信息。 | 新版 |
| [更新订阅日历](0265-update-subscription-calendar.md) | 调用本接口更新单个订阅日历信息。 | 新版 |
| [删除订阅日历](0266-delete-subscription-calendar.md) | 调用本接口删除订阅日历。 | 新版 |

#### **签到**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [查看单个日程的签到详情](0267-view-the-check-in-details-of-a-single-schedule.md) | 调用本接口，查看单个日程的签到详情。 | 新版 |
| [针对单个日程进行签到](0269-sign-in-single-schedule-news.md) | 根据日程ID对指定日程进行签到。 | 新版 |
| [针对单个日程进行签退](0270-sign-off-for-a-single-schedule.md) | 根据日程ID对指定日程进行签退。 | 新版 |
| [查看单个日程的签退详情](0268-view-the-billing-details-of-a-single-schedule.md) | 根据日程ID查询单个日程签到与未签到人员列表。 | 新版 |
| [获取签到链接](0271-api-getsigninlink.md) | 通过日历 ID、用户 unionId和日程 eventId，查询签到链接。 | 新版 |
| [获取签退链接](0272-api-getsignoutlink.md) | 通过日历 ID、用户 unionId和日程 eventId，查询签退链接。 | 新版 |

#### **会议室**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [获取会议室忙闲信息](0273-queries-free-and-busy-meeting-room-information.md) | 获取会议室忙闲信息。 | 新版 |
| [预定会议室](0274-add-a-meeting-room.md) | 预定会议室。 | 新版 |
| [取消预定会议室](0275-remove-a-meeting-room.md) | 取消预定会议室。 | 新版 |
...
- [创建、修改、查询及删除日程](0244-create-and-delete-an-event.md)
- [添加、获取及删除日程参与者](0245-calendar-participant-process.md)
