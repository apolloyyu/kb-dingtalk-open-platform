...
| category\_code | String | 是 | BASIC\_INFO | 数据类别编码，可参考[数据类别](1133-teaching-data-overview.md#section-2mx-hrp-6et)介绍。 |
...
| category\_code | String | BASIC\_INFO | 数据类别编码，可参考[数据类别](1133-teaching-data-overview.md#section-2mx-hrp-6et)介绍。 |
...
| factor\_code | String | joinClassroomTime | 数据因子编码，可参考[数据因子](1133-teaching-data-overview.md#section-qcu-tp4-r03)介绍。 |
