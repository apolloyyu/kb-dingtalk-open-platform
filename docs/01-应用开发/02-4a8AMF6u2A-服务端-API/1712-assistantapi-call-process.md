...
具体信息参考[创建线程](1715-api-createassistantthread.md)文档

### **步骤二:添加Message到Thread中**

用户的Query的信息可以通过Message传入，可以创建一个Message给到指定的线程（Thread）；

具体信息参考[创建消息](1718-api-createassistantmessage.md)文档
...
- [创建AI助理的运行任务](1722-api-createassistantrun.md)文档
- [获取AI助理的运行任务](1723-api-retrieveassistantrun.md)文档
- [获取AI助理的消息列表](1720-api-listassistantmessage.md)文档
...
**接入参考文档：**[创建AI助理的运行任务](1722-api-createassistantrun.md)文档。
