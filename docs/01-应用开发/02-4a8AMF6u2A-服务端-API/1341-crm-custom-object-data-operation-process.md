...
1. 调用服务端API-[获取自定义对象的元数据](1373-get-metadata-description-of-crm-custom-object.md)接口，获取客户管理自定义对象的元数据信息。
2. 调用服务端API-[创建CRM自定义对象数据](1370-dingtalk-paas-master-create-custom-crm-object-data.md)接口，进行自定义对象数据的创建，获取自定义对象数据`instanceId`。
3. 根据自定义对象数据`instanceId`进行自定义对象数据管理操作。

   - 根据自定义对象数据`instanceId`，调用服务端API-[更新自定义对象数据](1372-crm-master-data-opens-interface-for-updating-custom-object-data.md)接口，进行更新自定义对象数据。
   - 根据自定义对象数据`instanceId`，调用服务端API-[删除CRM自定义对象数据](1371-delete-crm-custom-object-data.md)接口，进行删除自定义对象数据。
   - 根据自定义对象数据`instanceId`，调用服务端API-[按照ID列表批量获取CRM自定义表单数据](1375-retrieves-custom-crm-forms-from-the-id-list.md)接口，进行批量获取自定义对象数据信息。
4. 调用服务端API-[根据指定条件查询自定义对象数据](1374-api-getobjectdata.md)接口，查询符合指定条件的自定义对象数据。
...
3. 根据自定义对象数据`instanceId`进行自定义对象数据管理操作。
   ...
   - 根据自定义对象数据instanceId，调用服务端API-[更新自定义对象数据](1372-crm-master-data-opens-interface-for-updating-custom-object-data.md)接口，进行更新自定义对象数据。
