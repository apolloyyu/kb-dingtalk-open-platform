...
doc_id: "xjAAfXetpB"
updated_at: "2026-08-25 09:39:11"
---

> Source: https://open.dingtalk.com/document/development/ai-assistant-messages-reply-mode
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 智能交互 > AI 助理发消息（回复消息模式）
> Updated: 2026-08-25 09:39:11

# AI 助理发消息（回复消息模式）

本文档介绍的接口是回复接口，用户先与聊天对象（比如 AI 助理）发起对话，然后开发者获取到钉钉颁发的会话凭证，然后开发者可以使用会话凭证调用回复接口，回复用户的话。
