...
archived: false
method: POST
endpoint: https://oapi.dingtalk.com/topapi/crm/objectdata/followrecord/list
api_version: v1-oapi
app_types: 企业内部应用
...
## Body
- data_id_list (String, required): 数据ID列表，可通过根据指定条件查询跟进记录数据接口获取instance_id参数值，多个用英文逗号隔开。
