...
> Path: 应用开发 / 服务端 API / 文档/文件 > 存储管理 > 文件管理 > 获取文件或文件夹信息
...
| dentryId | String | 是 | 文件或文件夹Id，可调用[获取文件或文件夹列表](0665-get-a-list-of-files-or-folders.md)或[根据dentryUuid获取spaceId和dentryId](0672-api-getdentryidbyuuid.md)接口获取id参数值。 |
