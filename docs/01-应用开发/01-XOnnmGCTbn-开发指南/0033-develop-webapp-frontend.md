...
5. 前端 引入 JS SDK，详情参考[客户端SDK介绍](0031-webapp-read-before-development.md)。
...
- 企业内部应用：[发布应用](0019-publish-dingtalk-application.md)，如果你需要实现免登、接入事件订阅和使用钉钉服务端 API，需要[开发网页应用服务端](0034-develop-webapp-backend.md)。
- 第三发企业应用：[配置网页应用](0032-configure-web-application.md)
