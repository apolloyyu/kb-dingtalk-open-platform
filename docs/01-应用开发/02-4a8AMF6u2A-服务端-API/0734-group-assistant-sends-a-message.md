...
8. 进入对应群模板，提交审核，点击发布。
9. 依据**template\_id**调用[创建场景群](0747-create-a-scene-group.md)接口，获取`open_conversation_id`。
10. 调用[发送群助手消息](0764-group-template-robot-message.md)接口，实现机器人群消息的发送。
...
10. 通过**template\_id**调用[创建场景群](0747-create-a-scene-group.md)接口，获取`open_conversation_id`。
11. 调用[发送群助手消息](0764-group-template-robot-message.md)接口，实现机器人群消息的发送。
