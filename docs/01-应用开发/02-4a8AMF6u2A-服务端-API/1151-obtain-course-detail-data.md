...
> Path: 应用开发 / 服务端 API / 行业与生态 > 行业开放 > 新教育 > 在线课堂 > 获取课堂明细数据
...
| course\_code | String | 是 | GJKI49001 | 课程唯一编码，调用[创建课程](1138-create-course.md)接口获取course\_code参数值。 |
| category\_code | String | 是 | BASIC\_INFO | 数据类别编码，可参考[数据类别](1137-teaching-data-overview.md#section-2mx-hrp-6et)介绍。 |
...
| category\_code | String | BASIC\_INFO | 数据类别编码，可参考[数据类别](1137-teaching-data-overview.md#section-2mx-hrp-6et)介绍。 |
...
| factor\_code | String | joinClassroomTime | 数据因子编码，可参考[数据因子](1137-teaching-data-overview.md#section-qcu-tp4-r03)介绍。 |
