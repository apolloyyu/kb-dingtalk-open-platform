...
| msg\_task\_id | Number | 是 | 256271667526 | 发送消息时钉钉返回的任务ID，调用[发送工作通知](0770-asynchronous-sending-of-enterprise-session-messages.md)接口获取task\_id参数值。  **[!NOTE]**  仅支持撤回24小时内的工作消息通知。 |
