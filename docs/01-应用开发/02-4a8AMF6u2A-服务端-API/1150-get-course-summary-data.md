...
> Path: 应用开发 / 服务端 API / 行业与生态 > 行业开放 > 新教育 > 在线课堂 > 获取课堂概要数据
...
| category\_codes | String[] | 是 | BASIC\_INFO,RAISE\_HAND | 数据类别编码数组，可参考[数据类别](1137-teaching-data-overview.md#section-2mx-hrp-6et)介绍。 |
