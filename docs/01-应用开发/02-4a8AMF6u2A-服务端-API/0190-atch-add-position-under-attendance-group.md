...
> Path: 应用开发 / 服务端 API / 考勤 > 考勤组管理 > 批量新增地点
...
| group\_key | String | 是 | 03B1Exxxx | 考勤组ID。  **[!NOTE]**  如果你使用的考勤组标识是group\_id，可以调用[groupId转换为groupKey](0176-groupid-to-groupkey.md)接口将group\_id转换为group\_key。 |
