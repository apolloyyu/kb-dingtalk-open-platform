...
doc_id: "modgxcfk5D"
updated_at: "2026-08-27 14:07:16"
---

> Source: https://open.dingtalk.com/document/development/disable-the-sticky-card-setting
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 酷应用 > 关闭互动卡片实例置顶
> Updated: 2026-08-27 14:07:16
...
> - 未接入的开发者建议使用新版[关闭互动卡片吊顶](0762-close-interactive-card-ceiling.md)接口，已接入用户不受影响。
...
| openConversationId | String | 否 | 群的openConversationId，可调用[创建群](1483-create-a-scene-group-v2.md)接口获取。  **[!NOTE]**  会话类型为群聊时，该参数必填。 |
