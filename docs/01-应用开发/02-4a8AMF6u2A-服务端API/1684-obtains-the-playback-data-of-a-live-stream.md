...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| chat\_id | String | 是 | cidzZ7txxxx | 直播绑定的群列表ID。   - 小程序通过[选择会话](../03-Ogu5SlPY4t-客户端JSAPI/0744-select-session.md)方法获取。 - 微应用通过[根据corpid选择会话](../03-Ogu5SlPY4t-客户端JSAPI/0803-select-session-based-on-corpid.md)方法获取。 |
