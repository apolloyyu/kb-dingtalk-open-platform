...
> **[!IMPORTANT]**
>
> 推送的授权变更信息并不包括企业用户具体做了什么修改，所以收到推送之后，ISV需要通过调用[获取通讯录权限范围](../02-4a8AMF6u2A-服务端-API/0052-obtain-corpsecret-authorization-scope.md)查询新的授权范围，通讯录授权范围变更事件适用于第三方企业应用。
