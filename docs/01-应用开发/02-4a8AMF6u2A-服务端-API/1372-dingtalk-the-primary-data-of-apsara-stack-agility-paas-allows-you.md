...
| data\_id\_list | String | 是 | INST\_XX1,INST\_XX2 | 数据ID列表，可通过[根据指定条件查询跟进记录数据](1371-query-and-dingtalk-data-of-track-records-in-apsara-stack.md)接口获取instance\_id参数值，多个用英文逗号隔开。 |
