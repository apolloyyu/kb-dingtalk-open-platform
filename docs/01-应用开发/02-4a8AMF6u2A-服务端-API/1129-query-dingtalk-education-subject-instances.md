...
| subject\_code | String | 否 | cn\_p\_shuxue | 学科编码，调用[获取学科元数据列表](1131-dingtalk-the-main-data-of-the-education-ecosystem-query-the-subject.md)接口获取subject\_code参数值。 |
