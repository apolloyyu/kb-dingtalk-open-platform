...
> Path: 应用开发 / 服务端 API / 更多开放 > 服务窗 > 批量发送服务窗消息
> Updated: 2026-06-04 19:12:00
...
- 目前支持的消息格式有文本、链接、卡片、markdown等,消息类型详见[消息类型介绍](1279-service-window-message-types-1.md)。
...
| accountId | String | 否 | 服务窗账号id，[自建服务窗应用](1280-self-built-service-window-application.md)调用时不需要传此参数。  非自建服务窗应用需要传此参数，此参数可以通过[获取企业下服务窗列表](1283-queries-the-list-of-services-under-an-enterprise.md)接口获得。 |
