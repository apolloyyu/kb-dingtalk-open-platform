...
| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [创建钉钉待办任务](0794-add-dingtalk-to-do-task.md) | 发起一个钉钉待办任务。 | 新版 |
| [创建钉钉个人待办任务](0795-api-createpersonaltodotask.md) | 创建一个钉钉“个人待办“任务。 | 新版 |
| [删除钉钉待办任务](0796-delete-dingtalk-to-do-tasks.md) | 删除钉钉待办任务信息。 | 新版 |
| [更新钉钉待办任务](0797-updates-dingtalk-to-do-tasks.md) | 更新钉钉待办任务信息及状态。 | 新版 |
| [更新钉钉待办执行者状态](0798-update-dingtalk-to-do-status.md) | 当待办存在多个执行者时，可调用本接口更新部分执行者的完成状态。 | 新版 |
| [查询企业下用户待办列表](0799-query-the-to-do-list-of-enterprise-users.md) | 获取该授权企业下某用户的待办列表。 | 新版 |
| [新增待办卡片类型配置](0800-add-todo-cardtype-configuration.md) | 新增一个待办卡片类型。 | 新版 |
| [更新待办卡片类型配置](0801-update-the-to-do-card-type-configuration.md) | 更新已有的待办卡片类型。 | 新版 |
| [获取待办卡片类型配置详情](0802-queries-the-to-do-card-type-configuration-details.md) | 根据ID获取一个待办卡片类型配置详情。。 | 新版 |
