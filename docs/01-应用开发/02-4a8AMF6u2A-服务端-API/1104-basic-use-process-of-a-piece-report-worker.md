...
1. 调用服务端API-[计件报工](1105-riqing-monthly-settlement-piece-rate-reporting-interface.md)接口，产生报工记录。
2. 调用服务端API-[查询计件报工数据](1106-riqing-monthly-settlement-query-interface-for-piece-rate-reporting.md)接口，查询报工的详情信息。
...
- 根据创建的工单编号，调用服务端API-[计件报工](1105-riqing-monthly-settlement-piece-rate-reporting-interface.md)接口，对此工单进行报工，得到报工id。
...
- 根据报工id，调用服务端API-[查询计件报工数据](1106-riqing-monthly-settlement-query-interface-for-piece-rate-reporting.md)接口，获取本次报工记录的详情数据信息。
