...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| processInstanceId | String | 是 | 审批实例ID：   - 调用[发起审批实例](0496-create-an-approval-instance.md)接口获取`InstanceId`参数值。 - 调用[获取单个审批实例详情](0500-obtain-an-approval-list-of-instance-ids.md)接口获取`list`参数值。 |
