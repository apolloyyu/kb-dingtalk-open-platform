...
| API | 说明 |
| --- | --- |
| [创建并开启互动卡片吊顶](../02-4a8AMF6u2A-服务端-API/0762-send-group-helper-message.md) | 酷应用在企业内部群创建并开启互动卡片吊顶。 |
| [关闭互动卡片吊顶](../02-4a8AMF6u2A-服务端-API/0763-close-interactive-card-ceiling.md) | 酷应用在企业内部群关闭互动卡片吊顶。 |
...
调用服务端API-[创建并开启互动卡片吊顶](../02-4a8AMF6u2A-服务端-API/0762-send-group-helper-message.md)接口，实现发送吊顶卡片。
