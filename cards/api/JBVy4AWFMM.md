...
archived: true
method: —
endpoint: https://oapi.dingtalk.com/department/create
api_version: v1-oapi
...
- parentid (String, required): 父部门ID，根部门ID为1。
- optional: parentBalanceFirst(Boolean), shareBalance(Boolean), autoApproveApply(Boolean), outerPermitUsers(String), outerPermitDepts(String), outerDept(Boolean), deptHiding(Boolean), createDeptGroup(Boolean), order(String), sourceIdentifier(String), deptPermits(String), userPermits(String), outerDeptOnlySelf(Boolean), ext(String)
