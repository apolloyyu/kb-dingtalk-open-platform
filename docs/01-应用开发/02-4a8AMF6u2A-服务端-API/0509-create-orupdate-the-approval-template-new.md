...
> Path: 应用开发 / 服务端 API / OA 审批 > 自有 OA 审批 > 审批表单 > 创建或更新审批模板
...
| FormComponent | FormComponent | 是 | 表单控件，支持的控件参考[FormComponent参数说明](0473-oa-formcomponent-message.md#900adc515fxr6)，单一表单最大组件个数不超过200。 |
