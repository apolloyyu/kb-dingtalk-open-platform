...
| group\_id | Number | 是 | 685935028 | 考勤组ID，可调用[批量获取考勤组详情](0178-batch-obtain-attendance-group-details.md)接口获取group\_id参数值。  **[!NOTE]**  如果是旧考勤组标识即group\_key，可调用[groupKey转换为groupId](0175-convert-groupkey-to-groupid.md)接口将group\_key转换为group\_id。 |
