...
> Path: 应用开发 / 服务端 API / 音视频 > 会议 > 查询会议录制中的文本信息
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| conferenceId | String | 否 | 会议ID，可调用[创建视频会议](0398-create-a-video-conference.md)接口获取conferenceId参数值。 |

### 查询参数

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 否 | 用户unionId，可调用[查询用户详情](0055-query-user-details.md)接口获取unionid参数值。 |
