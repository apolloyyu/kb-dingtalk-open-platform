...
> Path: 应用开发 / 服务端 API / 通讯录管理 > 角色管理 > 更新角色名称
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| roleId | Number | 是 | 1560985325 | 要更新的角色ID，可以调用[获取角色列表](0088-obtains-a-list-of-enterprise-roles.md)接口获取。  “默认”分组内的角色不支持修改，包括：负责人、主管、主管理员、子管理员。 |
