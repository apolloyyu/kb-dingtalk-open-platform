...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 应用管理 > 获取用户可见的企业应用列表
...
> - 未接入的开发者建议使用新版[获取用户可见的企业应用列表](0867-obtains-the-list-of-enterprise-applications-visible-to-a-user.md)接口，已接入用户不受影响。
