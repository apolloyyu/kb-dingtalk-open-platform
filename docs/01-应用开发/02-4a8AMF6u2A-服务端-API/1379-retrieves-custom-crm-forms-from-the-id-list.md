...
> Path: 应用开发 / 服务端 API / 更多开放 > 客户管理（官方CRM） > 自定义对象 > 按照ID列表批量获取CRM自定义表单数据
...
| data\_id\_list | String | 是 | INST\_XX1,INST\_XX2 | 数据ID列表，多个用英文逗号隔开，可通过[根据指定条件查询自定义对象数据](1378-api-getobjectdata.md)接口获取instance\_id参数值。 |
