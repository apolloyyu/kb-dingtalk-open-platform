...
doc_id: "i5lKDtsvmM"
updated_at: "2026-08-19 09:12:34"
---
...
- 如果在开发过程中遇到问题，可通过[联系我们](../01-ECKYIf1yqx-平台介绍/0001-custom-workbench-and-self-built-components.md#f0278e7bealct)入群咨询。
...
4. 单击**配置**，确认配置文件自动同组件代码的`config.json`同步。
   ...
   ![PC配置](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7051987261/p300318.png)
