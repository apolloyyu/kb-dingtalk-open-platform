...
> Path: 应用开发 / 服务端 API / 行业与生态 > 行业开放 > 设备上钉 > 获取巡检或保养记录
...
| deviceUuid | Array of String | 否 | 设备uuIi列表，调用[查询已经注册的设备信息](1114-query-information-about-a-registered-device.md)接口获取的uuid，最大值10。 |
