...
> Path: 应用开发 / 服务端 API / 更多开放 > 智能硬件 > DingTalk A1 > 创建DingTalkA1小助理分析
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| agentId | String | 否 | 小助理id，可接入[DingTalkA1小助理总结完成事件](../04-LFcRvVD08N-事件订阅/0120-events-aone-assistant-summary-change.md)获取agentId。 |
| openFileId | String | 否 | 录音文件id，可接入[DingTalkA1小助理总结完成事件](../04-LFcRvVD08N-事件订阅/0120-events-aone-assistant-summary-change.md)获取fileId。 |
