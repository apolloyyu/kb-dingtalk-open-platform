...
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > H5微应用 > JSAPI参考 > 钉盘 > 预览钉盘文件
...
> **[!NOTE]**
>
> 在调用本接口预览钉盘文件之前，你需要先调用[授权预览审批附件](../02-4a8AMF6u2A-服务端-API/0502-official-authorized-preview-approval-attachment.md)或[授权用户访问企业的自定义空间](../02-4a8AMF6u2A-服务端-API/1556-authorize-a-user-to-access-a-custom-workspace-of-an.md)进行授权。
