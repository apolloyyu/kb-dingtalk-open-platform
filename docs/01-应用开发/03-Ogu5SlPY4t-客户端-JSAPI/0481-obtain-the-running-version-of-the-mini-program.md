...
doc_id: "M914rQoVDg"
updated_at: "2026-09-01 09:16:33"
---

> Source: https://open.dingtalk.com/document/development/obtain-the-running-version-of-the-mini-program
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 基础 API > 获取小程序的运行版本
> Updated: 2026-09-01 09:16:33
...
| 属性 | 类型 | 描述 |
| --- | --- | --- |
| envVersion | String | 小程序当前运行的版本：   - **debug**：开发版。 - **trial**：体验版。 - **release**：线上版。 |
