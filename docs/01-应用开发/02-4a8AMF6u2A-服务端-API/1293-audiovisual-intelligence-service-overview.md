...
| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [获取客户信息](1294-api-getcustomerinfo.md) | 通过本接口，获取AI销售管理中的单条客户数据。 | 新版 |
| [查询团队列表](1295-api-listteam.md) | 调用本接口，获取AI销售管理中的团队列表信息。 | 新版 |
| [查询设备属性](1296-api-querydevicestatus.md) | 通过本接口，批量获取指定的智能语音设备（A1或B1）的状态。 | 新版 |
| [查询单条服务记录](1297-api-getservicerecord.md) | 通过本接口，使用服务记录ID获取AI销售管理中的指定服务记录。 | 新版 |
| [获取服务待办信息](1298-api-listservicetodo.md) | 调用本接口，通过服务记录ID，获取AI销售管理中的服务记录待列表。 | 新版 |
| [获取服务会话总结](1299-api-getservicechatsummary.md) | 调用本接口，通过服务记录ID，获取AI销售管理中的服务会话总结。 | 新版 |
| [获取服务表现数据](1300-api-getservicequalityinspection.md) | 通过本接口，根据服务记录ID，获取AI销售管理中的服务表现数据。 | 新版 |
| [分页查询客户列表](1301-api-listcustomer.md) | 通过本接口，分页获取AI销售管理中的客户数据。 | 新版 |
| [分页查询设备列表](1302-api-listdevice.md) | 调用本接口，分页查询AI销售管理中的设备列表。 | 新版 |
| [批量获取设备详情](1303-api-querydevicedetail.md) | 通过本接口，批量获取指定SN的智能音频设备（A1或B1）详情。 | 新版 |
| [更新设备绑定关系](1304-api-updatedevicebinding.md) | 通过本接口，更新AI销售管理中硬件设备与使用人之间的绑定关系。 | 新版 |
| [获取音频文件信息](1305-api-getaudiofileinfo.md) | 通过本接口，获取智能音频设备（A1或B1）产生的音频文件信息。 | 新版 |
| [查询ASR转写结果](1306-api-getasrtranscription.md) | 调用本接口查询[创建ASR离线转写任务]的转写结果。 | 新版 |
| [创建ASR离线转写任务](1307-api-createasrtranscription.md) | 调用本接口，创建音频离线转写任务。 | 新版 |
| [获取服务对话章节摘要](1308-api-getservicechaptersummary.md) | 通过本接口，获取AI销售管理中的服务记录对话章节摘要。 | 新版 |
| [获取文件转写的概要信息](1309-api-gettranscriptsummary.md) | 通过本接口，获取智能语音设备产生的音频文件转写概要信息。 | 新版 |
| [获取AI销售管理客户洞察信息](1310-api-getcustomerinsight.md) | 通过本接口，获取AI销售管理中的客户洞察信息。 | 新版 |
| [根据听记ID获取A1音频文件信息](1311-api-queryfileinfobyminutesid.md) | 通过本接口，可以使用A1文件产生的听记ID反查A1文件信息。 | 新版 |
| [分页获取企业下的服务记录信息](1312-api-listservicerecord.md) | 调用本接口，分页获取企业下的服务记录信息。 | 新版 |
| [分页查询指定设备的音频文件列表](1313-api-queryaudiofile.md) | 通过本接口，分页查询智能设备（A1或B1）产生的音频文件。 | 新版 |
