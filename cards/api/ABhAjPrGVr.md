...
archived: false
method: POST
endpoint: https://api.dingtalk.com/v1.0/jzcrm/customerPools
api_version: v2-new
app_types: 第三方企业应用
...
## Body
- datatype (Long, required): 数据类型，固定值**238**。
...
updated_at: 2026-06-02 20:00:58
