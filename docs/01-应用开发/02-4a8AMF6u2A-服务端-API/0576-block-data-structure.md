...
> Path: 应用开发 / 服务端 API / 文档/文件 > 文档 > 数据结构 > 块元素数据结构
...
| 字段名 | 类型 | 必填 | 含义 |
| --- | --- | --- | --- |
| sticker | string(enum Emoji) | 否 | 表情编码，详见 [表情（Emoji）枚举值](0577-enumeration-values-of-emojis.md)。 |
...
| 字段名 | 类型 | 必填 | 含义 |
| --- | --- | --- | --- |
| code | string(enum Emoji) | 是 | 表情编码，详见[表情（Emoji）枚举值](0577-enumeration-values-of-emojis.md)。 |
