...
doc_id: "GS9AfJYFOa"
updated_at: "2026-08-27 14:21:31"
---

> Source: https://open.dingtalk.com/document/development/equipment-membership
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 钉钉物联 > 设备入会
> Updated: 2026-08-27 14:21:31
...
| deviceIds | Array of String | 是 | 邀请的设备ID，最多5个，调用[注册设备](1831-register-devices.md)或者[批量注册设备](1832-batchregister-devices.md)接口获取。 |
