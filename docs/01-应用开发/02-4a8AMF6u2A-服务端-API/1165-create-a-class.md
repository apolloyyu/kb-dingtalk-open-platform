...
> Path: 应用开发 / 服务端 API / 行业与生态 > 行业开放 > 新教育 > 家校通讯录2.0 > 创建班级
...
| super\_id | Number | 是 | 4240018 | 年级ID，可调用[获取部门列表](1157-obtains-the-department-node-list.md)接口获取dept\_type为grade时的dept\_id参数值。 |
