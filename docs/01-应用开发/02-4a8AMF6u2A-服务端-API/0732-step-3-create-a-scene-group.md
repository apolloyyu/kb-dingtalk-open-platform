...
完成[创建群聊会话（场景群）](0735-create-a-group-chat-session.md)的流程。
...
3. 存量群升级场景群：
   ...
   - 调用[启用群模板](0760-enable-a-group-template.md)接口，你可以将存量群升级为场景群。
   - 你可以登录钉钉客户端：
...
> 如果你需要通过接口直接创建场景群，请参考[创建场景群](0747-create-a-scene-group.md)接口。
