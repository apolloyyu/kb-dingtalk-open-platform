...
> Path: 应用开发 / 服务端 API / 文档/文件 > 存储管理 > 文件传输 > 获取文件上传信息
...
> **[!NOTE]**
>
> - 如果上传文件时提供的入参为spaceId字段，使用[获取文件上传信息](1599-obtain-storage-upload-information.md)接口。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| parentDentryUuid | String | 是 | 父节点dentryUuid，可调用[搜索文件](0637-search-for-files.md)或[获取 dentryUuid 信息](0671-api-getuuidbydentryid.md)接口，获取返回参数`dentryUuid`字段。    如果是空间根目录, 填空间根目录的dentryUuid。 |
