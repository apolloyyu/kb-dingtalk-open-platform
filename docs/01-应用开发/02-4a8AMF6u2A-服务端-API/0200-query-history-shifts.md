...
> Path: 应用开发 / 服务端 API / 考勤 > 考勤班次 > 查询历史班次
...
| shift\_id | Number | 是 | 628380875 | 班次ID，可通过[获取班次摘要信息](0202-enterprise-shift-query-in-batches.md)接口获取id参数值。 |
| version | Number | 是 | 624190327 | 班次版本，可通过[批量查询人员排班信息](0205-query-batch-scheduling-information.md)接口获取shift\_version参数值。 |
