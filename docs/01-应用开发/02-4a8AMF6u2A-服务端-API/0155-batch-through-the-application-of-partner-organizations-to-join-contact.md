...
> Path: 应用开发 / 服务端 API / 通讯录管理 > 上下级组织（原关联组织） > 批量通过伙伴组织的加入申请
...
| linkDeptId | Long | 否 | 分支组织在主干组织内的位置，可调用[获取部门列表](0081-user-management-acquires-the-list-departments.md)接口获取dept\_id参数值。 |
