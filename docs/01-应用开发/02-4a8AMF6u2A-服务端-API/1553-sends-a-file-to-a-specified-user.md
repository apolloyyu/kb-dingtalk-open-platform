...
> - 未接入的开发者建议使用新版[以应用身份发送文件给指定用户](0640-sends-a-storage-file-to-a-specified-user.md)接口，已接入用户不受影响。
...
| agent\_id | String | 是 | 123 | 文件发送者应用的AgentId。   - 企业内部应用可以在[开发者后台](https://open-dev.dingtalk.com/)的应用详情页获取。 - 第三方企业应用可以调用[获取企业授权信息](0041-obtains-the-basic-information-of-an-enterprise.md)接口获取。 |
