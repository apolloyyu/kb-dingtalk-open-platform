...
doc_id: "9TYOowL6HI"
updated_at: "2026-08-27 12:32:17"
---

> Source: https://open.dingtalk.com/document/development/query-the-whitelist-of-live-courses
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 培训 > 查询直播课程的可观看白名单
> Updated: 2026-08-27 12:32:17
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| feedId | String | 是 | 直播课程ID，可通过[创建培训课程](1681-create-live-courses.md)接口获取。 |
