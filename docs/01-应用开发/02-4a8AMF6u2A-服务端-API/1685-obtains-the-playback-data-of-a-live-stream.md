...
> - 未接入的开发者建议使用新版[查询直播的观看数据](1495-queries-the-playback-data-of-a-live-stream.md)接口，已接入用户不受影响。
...
| feed\_id | String | 是 | c16a6277-a538-466xxxx | 课程ID，调用[创建培训课程](1682-create-live-courses.md)接口返回的课程ID。 |
