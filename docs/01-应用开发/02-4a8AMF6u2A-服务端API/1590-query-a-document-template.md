...
| workspaceId | String | 否 | 知识库ID，调用[新建知识库](1584-create-a-team-space.md)接口或者[查询用户有权限的知识库列表](1586-querying-the-list-of-user-team-spaces.md)接口获取的workspaceId字段值。  **[!NOTE]**  当参数`templateType=team_template`，该参数必传。 |
