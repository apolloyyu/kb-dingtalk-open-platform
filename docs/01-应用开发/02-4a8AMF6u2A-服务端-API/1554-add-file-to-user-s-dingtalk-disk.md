...
>   - 企业审批附件钉盘空间，需通过[获取审批钉盘空间信息](0501-obtains-the-information-about-approval-nail-disk.md)接口进行授权。
...
| agent\_id | String | 否 | 123 | 应用的AgentId。   - 企业内部应用可以在[开发者后台](https://open-dev.dingtalk.com/)的应用详情页获取。 - 第三方企业应用可以调用[获取企业授权信息](0041-obtains-the-basic-information-of-an-enterprise.md)接口获取。 |
...
| media\_id | String | 是 | @123 | 调用[单步文件上传](1579-single-step-file-upload.md)接口得到的media\_id。 |
