...
| terminationReasonVoluntary | Array of String | 否 | 主动离职原因id，可调用[获取企业已有的所有离职原因](0954-api-getalldismissionreasons.md)接口获取。 |
| terminationReasonPassive | Array of String | 否 | 被动离职原因id，可调用[获取企业已有的所有离职原因](0954-api-getalldismissionreasons.md)接口获取。 |
| remark | String | 否 | 备注。 |
