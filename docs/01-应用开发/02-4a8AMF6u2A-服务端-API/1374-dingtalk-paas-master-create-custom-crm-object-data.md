...
> Path: 应用开发 / 服务端 API / 更多开放 > 客户管理（官方CRM） > 自定义对象 > 创建CRM自定义对象数据
...
| data | String | 是 | {"TextField-xxxxxx":"李四"} | 数据内容，JSON格式字符串。传参格式详见[自定义控件字段格式说明V1](1388-custom-control-field-format-description-v1.md)。 |
