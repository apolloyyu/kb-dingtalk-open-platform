...
> - 未接入的开发者建议使用新版[获取部门用户详情](0061-queries-the-complete-information-of-a-department-user.md)接口，已接入用户不受影响。
...
| department\_id | Number | 是 | 1 | 获取的部门ID。1表示根部门，可调用[获取部门列表](1466-obtain-the-department-list.md)。  **[!NOTE]**  只获取当前部门下的员工信息，不包含子部门内的员工。 |
