...
> Path: 应用开发 / 服务端 API / 考勤 > 假勤审批 > 通知补卡通过
...
| work\_date | String | 是 | 2019-08-15 | 要补卡的时间，可通过[批量查询人员排班信息](0205-query-batch-scheduling-information.md)接口获取的work\_date值。 |
| punch\_id | Number | 是 | 176877195378 | 要补的排班ID，可通过[批量查询人员排班信息](0205-query-batch-scheduling-information.md)接口获取的shift\_id值。 |
| punch\_check\_time | String | 是 | 2019-08-15 08:00 | 排班的打卡时间，可通过[批量查询人员排班信息](0205-query-batch-scheduling-information.md)接口获取的plan\_check\_time值。 |
