...
> Path: 应用开发 / 服务端 API / 考勤 > 考勤组管理 > 获取参与考勤人员的userid
...
| group\_id | Number | 是 | 98562 | 考勤组ID。  **[!NOTE]**  如果你使用的是旧考勤组标识即group\_key，可以调用[groupKey转换为groupId](0175-convert-groupkey-to-groupid.md)接口将group\_key转换为group\_id。 |
