...
doc_id: "QtynrCwvnM"
updated_at: "2026-09-01 09:16:54"
---

> Source: https://open.dingtalk.com/document/development/get-wi-fi-list
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 设备 > Wi-Fi > 获取Wi-Fi列表
> Updated: 2026-09-01 09:16:54
...
在 [onGetWifiList](0643-listener-to-get-wi-fi-list-event.md) 注册的回调中返回 wifiList 数据。iOS 将跳转到系统设置中的钉钉设置页，需要用户手动进入「无线局域网」设置页，Android 不会跳转。
