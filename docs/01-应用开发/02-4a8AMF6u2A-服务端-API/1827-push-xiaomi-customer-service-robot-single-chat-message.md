...
doc_id: "kSYbxbnvG4"
updated_at: "2026-08-27 14:18:53"
---

> Source: https://open.dingtalk.com/document/development/push-xiaomi-customer-service-robot-single-chat-message
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 生态开放 > 小蜜客服 > 推送小蜜机器人单聊O2O消息
> Updated: 2026-08-27 14:18:53
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| chatbotId | String | 是 | 机器人标识，由小蜜客服平台提供，加入小蜜客服咨询群联系负责人提供，详细请参考[小蜜客服介绍](https://www.yuque.com/dingdingxiaomikefu/cdvg5o/dcm5ty)。 |
| userId | String | 是 | 用户的userid。 |
| msgKey | String | 是 | 消息类型，详情可参考[消息类型说明](1830-message-types-xiaomi-customer-service.md)。 |
