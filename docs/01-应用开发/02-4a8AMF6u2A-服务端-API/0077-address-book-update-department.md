...
> Path: 应用开发 / 服务端 API / 通讯录管理 > 部门管理 > 更新部门
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| dept\_id | Number | 是 | 100 | 部门ID，可通过[获取部门列表](0081-user-management-acquires-the-list-departments.md)接口获取dept\_id参数值。 |
| parent\_id | Number | 否 | 2 | 父部门ID，根部ID为1。可通过[获取部门列表](0081-user-management-acquires-the-list-departments.md)接口获取parent\_id参数值。 |
