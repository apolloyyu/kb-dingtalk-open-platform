...
| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [新建知识库](0556-new-knowledge-base.md) | 创建组织下的知识库。 | 新版 |
| [获取知识库](0557-obtain-the-knowledge-base.md) | 查询知识库信息。 | 新版 |
| [置顶知识库](0558-api-pinspace.md) | 根据知识库 ID 和 操作者 UnionID，将对应知识库置顶。 | 新版 |
| [获取知识库列表](0559-get-knowledge-base-list.md) | 根据操作人unionId，获取知识库列表信息。 | 新版 |
| [批量获取知识库](0560-batch-acquisition-of-knowledge-base.md) | 根据操作人unionId和知识库ID，查询知识库信息。 | 新版 |
| [知识库转交所有者](0561-api-handoveryworkspace.md) | 将知识库所有者转交给他人。 | 新版 |
| [获取我的文档知识库信息](0562-get-my-documents.md) | 根据操作人unionId，获取操作人的文档信息。 | 新版 |

#### **目录树管理**

| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [复制文档](0563-api-copydoc.md) | 将节点复制到其他节点下。 | 新版 |
| [创建快捷方式](0564-api-createshortcut.md) | 创建知识库或文件的快捷方式。。 | 新版 |
| [获取任务状态](0565-api-gettaskinfo.md) | 通过Task查询任务状态，可与复制文档结合使用。 | 新版 |
| [创建知识库文档](0566-create-team-space-document.md) | 在知识库内创建文档或者文件夹。 | 新版 |
| [删除知识库文档](0567-delete-team-space-documents.md) | 删除团队空间文档或者文件夹。 | 新版 |
| [知识库下载文件](0568-knowledge-base-download-file.md) | 获取知识库中文件的下载信息。 | 新版 |
| [获取节点](0569-get-knowledge-base-acquisition-node.md) | 根据操作者unionId和节点id，获取单个节点信息。 | 新版 |
| [获取节点列表](0570-get-node-list.md) | 根据父节点ID，查询父节点下的节点列表。 | 新版 |
| [通过链接获取节点](0571-get-node-by-link.md) | 根据操作者unionId和文档链接，获取节点信息。 | 新版 |
| [批量获取节点](0572-obtain-nodes-in-batch.md) | 根据节点id和操作人unionId信息，批量查询节点信息。 | 新版 |
...
- [知识库上传文件](0553-upload-files-to-the-knowledge-base.md)
- [知识库成员管理](0555-knowledge-base-member-management.md)
- [知识库权限变更](0554-change-of-knowledge-base-access-rights.md)
