...
> Path: 应用开发 / 钉钉 CLI / 高级集成 > OpenClaw 框架集成 > OpenClaw机器人手动配置
...
> **[!NOTE]**
>
> 钉钉开放平台已支持一键自动创建OpenClaw机器人应用，详情可查看[一键创建OpenClaw机器人·即刻拥有钉钉 AI 助理](0013-build-dingtalk-ai-employees.md)文档。
...
- 阿里云轻量服务器：请参考[阿里云轻量服务器部署](0015-deployment-of-alibaba-cloud-light-server.md)
- ECS服务器部署：请参考[阿里云ECS服务器部署](0016-deployment-alibaba-cloud-ecs-server.md)
- 本地安装OpenClaw：请参考[本地安装OpenClaw](0014-install-openclaw-locally.md)
