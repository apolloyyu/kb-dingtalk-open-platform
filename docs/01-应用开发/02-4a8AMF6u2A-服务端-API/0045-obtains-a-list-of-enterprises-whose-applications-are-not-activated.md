...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| suite\_access\_token | String | 是 | 6ed1bxxxx | 第三方企业应用的suite\_access\_token，可调用[获取第三方企业应用的suiteAccessToken](0035-obtains-the-suite-acess-token-of-third-party-enterprise-applications.md)接口获取凭证。 |
