...
doc_id: "i6SRAf3MjL"
updated_at: "2026-08-25 09:39:33"
---

> Source: https://open.dingtalk.com/document/development/querying-form-instance-data
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 宜搭 > 表单 > 查询表单实例数据
> Updated: 2026-08-25 09:39:33
...
> - 未接入的开发者建议使用新版[查询表单实例数据](0320-api-searchformdatas-v2.md)接口，已接入用户不受影响。
