...
> Path: 应用开发 / 服务端 API / 行业与生态 > 行业开放 > 服务群 > 更换服务群所在的群分组
...
| openConversationId | String | 否 | 开放群ID，可调用[创建场景服务群](1121-create-a-scenario-service-group.md)接口获取openConversationId参数值。 |
