...
| process\_instance\_id | String | 是 | EF6YJL35 | 实例ID，由[创建实例](1517-initiate-an-approval-process-without-a-process.md)接口获取。 |
| activity\_id | String | 是 | 1111 | 待办组ID，需要在调用[查询待办列表](1524-query-a-user-s-to-do-items.md)接口时，主动设置该值。 |
