...
| code | String | 是 | a6981a1df0c03297b70aa23a6db2ce65 | code值为应用免登授权码：   - [免登授权码](../03-Ogu5SlPY4t-客户端JSAPI/0515-mini-program-free-login.md) - [获取微应用免登授权码](../03-Ogu5SlPY4t-客户端JSAPI/0753-obtain-the-micro-application-exemption-authorization-code.md) |
| media\_id | String | 是 | @123 | 调用[单步文件上传](1580-single-step-file-upload.md)接口得到的media\_id。 |
