...
4. **获取审批中心数据：**企业自建审批中心应用可调用[关于新增OA审批高级版专享OpenAPI和解决方案的说明](1443-description-of-new-oa-approval-premium-exclusive-openapi-and-solutions.md)中的查询审批中心列表相关接口（高级版专享），分别获取用户在钉钉审批中心的[待处理](0535-api-premiumgettodotasks.md)、[已处理](0536-api-premiumgetdonetasks.md)、[已发起的](0527-api-premiumgetsubmittedinstances.md)、[已收到的](0528-api-premiumgetnoticedinstances.md)审批列表数据。
...
7. **流程交接：**企业自建审批中心应用也可调用[关于新增OA审批高级版专享OpenAPI和解决方案的说明](1443-description-of-new-oa-approval-premium-exclusive-openapi-and-solutions.md)中的流程交接相关接口，实现管理员批量将审批任务转交给组织内其他人员处理。
