...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 文档/文件 > 钉盘 > 文件传输 > 文件下载流程
...
1. 调用[获取文件下载信息](1570-obtain-download-file-info.md)接口，获取文件下载所需的加签URL信息。
...
2. 根据获取到的加签URL信息，下载文件。
   ...
   > **[!NOTE]**
   >
   > 必须使用[获取文件下载信息](1570-obtain-download-file-info.md)接口返回的加签URL信息和Header信息才能下载。
