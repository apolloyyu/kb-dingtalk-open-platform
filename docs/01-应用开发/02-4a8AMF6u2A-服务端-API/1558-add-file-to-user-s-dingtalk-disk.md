...
> - 未接入的开发者建议使用新版[获取文件上传信息](0675-obtain-file-upload-informations.md)和[提交文件](0676-submittal-file.md)接口，已接入用户不受影响。

> **[!NOTE]**
>
> - 调用该接口之前，不同的上传空间需要授权不同的上传权限：
>
>   - 自定义企业钉盘空间，需通过[添加权限](0682-add-permissions-file.md)接口进行授权。
...
| media\_id | String | 是 | @123 | 调用[单步文件上传](1583-single-step-file-upload.md)接口得到的media\_id。 |
