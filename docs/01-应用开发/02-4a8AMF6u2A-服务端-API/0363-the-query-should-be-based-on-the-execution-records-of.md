...
> Path: 应用开发 / 服务端 API / 宜搭 > 服务调用 > 查询宜搭表单服务调用执行记录
> Updated: 2026-06-03 10:11:59
...
| instanceId | String | 是 | 宜搭表单实例Id，调用[获取实例ID列表](0309-api-getinstanceidlist-v2.md)接口或者[获取多个表单实例ID](0323-api-searchformdataidlist-v2.md)接口获取。 |
