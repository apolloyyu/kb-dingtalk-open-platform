...
> - 未接入的开发者建议使用新版[获取审批实例ID列表](0500-obtain-an-approval-list-of-instance-ids.md)接口，已接入用户不受影响。
...
> **[!NOTE]**
>
> 可以通过本接口获取审批流对应的审批实例ID，然后再调用[获取单个审批实例详情](1532-get-details-single-approval-instance.md)接口，获取审批实例详情信息。
