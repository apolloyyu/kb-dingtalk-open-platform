...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | 是 | BExxx | 调用该接口的访问凭证，可通过调用[获取第三方企业应用的suiteAccessToken](0035-obtains-the-suite-acess-token-of-third-party-enterprise-applications.md)接口获取。 |
