...
| subject\_code\_list | String | 否 | [\"cn\_p\_shuxue\",\"cn\_p\_yuwen\"] | 学科编码列表，调用[获取学科元数据列表](1131-dingtalk-the-main-data-of-the-education-ecosystem-query-the-subject.md)接口获取subject\_code参数值。 |
| period\_code | String | 是 | primary\_school | 学段编码，调用[获取学段元数据列表](1125-dingtalk-the-main-data-of-the-education-ecosystem-to-query.md)接口获取period\_code参数值。 |
