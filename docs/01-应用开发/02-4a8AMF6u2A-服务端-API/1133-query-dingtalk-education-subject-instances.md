...
> Path: 应用开发 / 服务端 API / 行业与生态 > 行业开放 > 新教育 > 通用基础 > 获取学科实例详情
...
| subject\_code | String | 否 | cn\_p\_shuxue | 学科编码，调用[获取学科元数据列表](1135-dingtalk-the-main-data-of-the-education-ecosystem-query-the-subject.md)接口获取subject\_code参数值。 |
