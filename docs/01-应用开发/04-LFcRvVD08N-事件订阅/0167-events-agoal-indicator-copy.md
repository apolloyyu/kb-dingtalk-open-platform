...
- `data.body`（object）
- `data.body.originCode`（string）：被复制的指标的编码
- `data.body.code`（string）：复制生成的指标的编码
...
- `body`（object）
- `body.origin_code`（string）：被复制的指标的编码
- `body.code`（string）：复制生成的指标的编码
...
- `biz_data.body.origin_code`（string）：被复制的指标的编码
- `biz_data.body.code`（string）：复制生成的指标的编码
