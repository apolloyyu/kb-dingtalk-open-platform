...
archived: false
method: POST
endpoint: https://api.dingtalk.com/v1.0/badge/codes/userInstances
api_version: v2-new
app_types: 第三方企业应用
...
## Body
- requestId (String, required): 业务幂等ID，由调用方随机生成。
...
- gmtStart (String, required): 开始时间，格式：yyyy-MM-dd HH:mm:ss。 例如：`2021-10-20 00:00:00`。
- gmtEnd (String, required): 结束时间，格式：yyyy-MM-dd HH:mm:ss。 例如：`2021-11-20 00:00:00`。
