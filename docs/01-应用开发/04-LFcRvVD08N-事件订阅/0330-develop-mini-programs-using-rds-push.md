...
doc_id: "2Cr3DCDG4q"
updated_at: "2026-09-02 18:14:50"
---
...
- 绑定聚石塔账号，详情请参考[入驻聚石塔](https://open.dingtalk.com/document/development/create-tmallcloud-account)。
...
2. 单击**应用开发**，选择**第三方企业应用**，单击**创建应用**。
   ...
   ![p141770](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1704438871/p256635.png)
...
3. 单击**安全中心**，然后单击**添加**添加一个HTTP安全域名。小程序前端只能通过配置的安全域名（或IP）与服务端进行网络通信。当安全域名更新时，需要在IDE重新打包上传版本，设置的域名才会生效。
   ...
   ![p179116](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1704438871/p256216.png)
...
10. 登录开发者后台，在小程序详情页面，单击版本**管理与发布**，然后单击**灰度**添加使用该小程序的企业的corpid。
    ...
    ![p180068](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1704438871/p256315.png)
11. 灰度版本测试稳定后，单击**发布**。
