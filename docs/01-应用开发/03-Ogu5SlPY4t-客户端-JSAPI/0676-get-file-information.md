...
doc_id: "VbXmvsOjvn"
updated_at: "2026-09-01 09:17:10"
---

> Source: https://open.dingtalk.com/document/development/get-file-information
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 文件管理器 > 获取文件信息
> Updated: 2026-09-01 09:17:10
...
| **参数** | **类型** | **是否必填** | **描述** |
| --- | --- | --- | --- |
| filePath | String | 是 | 文件的路径。   - 本地临时文件路径，可调用[选择图片](0498-dd-chooseimage.md)或[选择视频](0506-dd-choosevideo.md)获取。 - 本地缓存文件和本地用户文件路径，可调用[保存文件](0675-save-file.md)获取。 |
