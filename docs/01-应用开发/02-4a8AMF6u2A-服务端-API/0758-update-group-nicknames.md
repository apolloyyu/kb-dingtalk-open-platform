...
支持以下场景使用：基于群模板创建的群，详情参见[创建群](1487-create-a-scene-group-v2.md)。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| openConversationId | String | 是 | 群ID，可调用[创建群](1487-create-a-scene-group-v2.md)接口获取`open_conversation_id`参数值。 |
