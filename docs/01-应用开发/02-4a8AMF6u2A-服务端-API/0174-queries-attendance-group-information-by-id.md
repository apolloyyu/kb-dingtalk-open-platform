...
> Path: 应用开发 / 服务端 API / 考勤 > 考勤组管理 > 根据groupKey查询考勤组信息
...
| group\_key | String | 是 | 02B1Exxxx | 考勤组groupKey。  **[!NOTE]**  如果你使用的考勤组标识是group\_id，可以调用[groupId转换为groupKey](0176-groupid-to-groupkey.md)接口将group\_id转换为group\_key。 |
...
| location\_offset | Number | 100 | 打卡范围，单位为米。  **[!NOTE]**  该字段已废弃，请以[批量查询地点](0192-batch-query-position-under-attendance-group.md)接口返回的offset为准。 |
