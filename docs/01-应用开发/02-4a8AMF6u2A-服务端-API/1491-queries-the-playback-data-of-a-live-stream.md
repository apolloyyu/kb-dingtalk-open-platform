...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| liveId | String | 是 | 直播ID，可调用[创建直播](0428-create-live-streaming.md)接口获取liveId参数值。 |
| unionId | String | 是 | 用户unionId，可调用[查询用户详情](0055-query-user-details.md)接口获取unionid参数值。 |
