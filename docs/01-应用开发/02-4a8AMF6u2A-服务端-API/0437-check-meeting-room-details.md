...
> Path: 应用开发 / 服务端 API / 音视频 > 智能会议室 > 会议室 > 查询会议室详情
> Updated: 2026-06-03 10:12:08
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 是 | 操作人的unionId，可调用[查询用户详情](0055-query-user-details.md)接口获取获取。 |
...
| memberId | String | 成员的id，memberType设置  人员：成员unionId，可调用[查询用户详情](0055-query-user-details.md)接口获取获取。  部门：部门id，dept\_id，可调用[获取部门列表](https://open.dingtalk.com/document/development/obtain-the-department-list-v2)接口获取。 |
