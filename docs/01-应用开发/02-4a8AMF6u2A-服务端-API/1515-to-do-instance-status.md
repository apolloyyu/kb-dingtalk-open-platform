...
> - 未接入的开发者建议使用新版[更新实例状态](0513-update-instance-status.md)接口，已接入用户不受影响。
...
| agentid | Number | 否 | 111 | 应用的agentid。   - 企业内部应用可在[开发者后台](https://open-dev.dingtalk.com/)的应用详情页获取。 - 第三方企业应用可调用[获取企业授权信息](0041-obtains-the-basic-information-of-an-enterprise.md)接口获取。 |
| process\_instance\_id | String | 是 | proc | 审批实例ID，由[创建实例](1514-initiate-an-approval-process-without-a-process.md)接口返回。 |
