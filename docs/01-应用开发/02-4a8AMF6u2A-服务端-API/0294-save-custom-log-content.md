...
调用本接口，请配合[三方系统发起和查看日志信息](0292-log-api-use-cases.md)案例使用，相当于把需要发送的日志内容打包，在需要发送日志的时候拉取该内容显示到日志模板中。
...
| key | String | 是 | 字段1 | 写日志对应的模板某个字段的标题，可调用[获取模板详情](0295-query-template-details.md)接口获取field\_name参数值。 |
