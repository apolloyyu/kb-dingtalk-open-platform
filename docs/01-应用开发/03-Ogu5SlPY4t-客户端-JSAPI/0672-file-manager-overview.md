...
- 支持产生本地临时文件的API有：
  ...
  - [选择视频](0506-dd-choosevideo.md)，获取本地视频的本地临时文件。
  - [下载文件](0486-mini-program-download-objects.md)，获取公网服务资源的本地临时文件。
