...
doc_id: "fIzwh8hMJW"
updated_at: "2026-08-27 14:07:10"
---

> Source: https://open.dingtalk.com/document/development/enable-the-interactive-card-setting
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 酷应用 > 开启互动卡片实例置顶
> Updated: 2026-08-27 14:07:10
...
| openConversationId | String | 否 | 群的openConversationId，可调用[创建群](1483-create-a-scene-group-v2.md)接口获取。  **[!NOTE]**  会话类型为群聊时需要传入此值。 |
