...
> Path: 应用开发 / 服务端 API / 宜搭 > 表单 > 获取表单内的组件信息
...
| formUuid | String | 是 | 表单唯一标识，可通过以下方式获取：   - 调用[获取指定应用下的表单列表](0333-depending-on-the-application-id-to-get-the-form-list.md)接口获取formUuid参数值。 - 通过应用获取： |
| userId | String | 是 | 操作人userId，可通过[获取部门用户userid列表](0064-query-the-list-of-department-userids.md)接口获取。 |
