...
> - 未接入的开发者建议使用新版[关闭互动卡片吊顶](0763-close-interactive-card-ceiling.md)接口，已接入用户不受影响。
...
| openConversationId | String | 否 | 群的openConversationId，可调用[创建群](1487-create-a-scene-group-v2.md)接口获取。  **[!NOTE]**  会话类型为群聊时，该参数必填。 |
