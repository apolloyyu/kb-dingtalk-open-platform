...
企业内部用户变更事件。该文档为企业修改员工信息字段说明，字段值来自于[查询用户详情](../02-4a8AMF6u2A-服务端-API/0056-query-user-details.md)接口 。
