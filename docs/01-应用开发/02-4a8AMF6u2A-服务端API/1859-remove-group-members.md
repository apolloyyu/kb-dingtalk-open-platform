...
| appUserIds | Array of String | 否 | 钉外账号在业务系统内的唯一标志，调用[创建钉钉客联钉外账号](1852-create-bc-account-association.md)接口获取，长度限制为1～64个字符，例如：1107\*\*\*\*2120。  **[!NOTE]**    被移除的钉外账号和钉内账号总和不能超过10个。 |
