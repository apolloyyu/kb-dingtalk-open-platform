...
步骤一：调用[获取文件上传信息](1600-obtain-storage-upload-information.md)接口，获取上传文件需要的信息。
...
>
> 可调用[添加权限](1596-add-storage-permissions.md)接口进行授权。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| uploadKey | String | 是 | 添加文件唯一标识，调用[获取文件上传信息](1600-obtain-storage-upload-information.md)接口获取uploadKey参数值。 |
