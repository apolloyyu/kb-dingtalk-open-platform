...
2. 实现应用免登。
   ...
   3. 获取免登授权码。
      ...
      - H5微应用获取授权码示例如下，详情请参考[免登流程](../03-Ogu5SlPY4t-客户端-JSAPI/0008-jsapi-request-auth-code.md)。
        ...
        ```
   4. 获取企业凭证，调用[获取第三方应用授权企业的accessToken](0033-obtain-the-access-token-of-the-authorized-enterprise-1.md)接口获取企业的凭证access\_token。
   5. 获取用户信息，调用[通过免登码获取用户信息](0023-obtain-the-userid-of-a-user-by-using-the-log-free.md)接口获取用户信息。
3. 集成教育相关接口。
...
- 新教育相关接口：
  ...
  - **家校通讯录接口：**
    ...
    文档详见：[家校通讯录2.0](1123-ai-overview-of-education.md#2e213c808bjzu)
