...
> Path: 应用开发 / 服务端 API / 即时通信 > 会话管理 > 群管理 > 获取入群二维码链接
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| chatid | String | 是 | chat3234dfs423a | 群会话的chatid，可调用[创建群会话](0739-create-common-group-new-version-v2.md)接口获取chatid参数值。 |
