...
> Path: 应用开发 / 服务端 API / 认证与授权 > 访问凭证 > 应用身份凭证 > 获取应用的 Access Token
...
- 企业内部应用：调用[获取企业内部应用的accessToken](0032-obtain-the-access-token-of-an-internal-app.md)接口，获取企业调用接口的凭证信息。
- 第三方企业应用：调用[获取第三方应用授权企业的accessToken](0033-obtain-the-access-token-of-the-authorized-enterprise-1.md)接口，获取第三方应用授权企业调用接口的凭证信息。
