...
> Path: 应用开发 / 服务端 API / 即时通信 > 机器人 > 消息发送与接收类型
...
> 如果上述消息类型均无法满足你的要求，可以使用[互动卡片](0778-overview-card.md)。
...
- [批量发送人与机器人会话中机器人消息](0715-chatbots-send-one-on-one-chat-messages-in-batches.md)
- [机器人发送群聊消息](0717-the-robot-sends-a-group-message.md)
...
详情参考[机器人发送群聊消息](0717-the-robot-sends-a-group-message.md)。
...
| messageUrl | String | 是 | 点击消息跳转的URL，打开方式如下：   - 移动端，在钉钉客户端内打开 - PC端    - 默认侧边栏打开   - 希望在外部浏览器打开，参考[消息链接说明](0777-message-link-description.md)。 |
...
- **整体跳转ActionCard类型**
  ...
  | singleURL | 是 | String | 点击消息跳转的URL，打开方式如下：  - 移动端，在钉钉客户端内打开 - PC端    - 默认侧边栏打开   - 希望在外部浏览器打开，参考[消息链接说明](0777-message-link-description.md)。 |
...
- **独立跳转ActionCard类型**
  ...
  | btns | 是 | Array | 按钮。 |
  | title | 是 | String | 按钮标题。 |
  | actionURL | 是 | String | 击按钮触发的URL，打开方式如下：  - 移动端，在钉钉客户端内打开 - PC端    - 默认侧边栏打开   - 希望在外部浏览器打开，参考[消息链接说明](0777-message-link-description.md)。 |
...
| messageURL | 是 | String | 点击单条信息到跳转链接，详情参考[消息链接说明](0777-message-link-description.md)。 |
...
| content | Object | 消息内容。 |
| richText | Array of Object | 富文本列表。  **[!NOTE]**  消息列表中可以包含：   - **text：**文本消息 - **picture**：图片消息  图片文件的下载码downloadCode，可通过调用服务端API-[下载机器人接收消息的文件内容](0720-download-the-file-content-of-the-robot-receiving-message.md)接口获取临时下载链接。 |
...
| downloadCode | String | 图片文件的下载码，用于换取下载图片的二进制文件，可通过调用服务端API-[下载机器人接收消息的文件内容](0720-download-the-file-content-of-the-robot-receiving-message.md)接口获取临时下载链接。 |
...
| downloadCode | String | 语音文件的下载码，用于换取下载语音的二进制文件，可通过调用服务端API-[下载机器人接收消息的文件内容](0720-download-the-file-content-of-the-robot-receiving-message.md)口获取临时下载链接。 |
...
| downloadCode | String | 视频文件的下载码，用于换取下载视频的二进制文件，可通过调用服务端API-[下载机器人接收消息的文件内容](0720-download-the-file-content-of-the-robot-receiving-message.md)接口获取临时下载链接。 |
...
| downloadCode | String | 文件的下载码，用于换取下载文件的二进制文件，可通过调用服务端API-[下载机器人接收消息的文件内容](0720-download-the-file-content-of-the-robot-receiving-message.md)接口获取临时下载链接。 |
| fileName | String | 文件名。 |
