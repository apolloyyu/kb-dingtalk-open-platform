...
| userId | String | 否 | 日程组织者的unionId。   - 企业内部应用和第三方企业应用，调用[查询用户详情](0055-query-user-details.md)接口获取unionid参数值。 - 第三方个人应用，调用[获取用户通讯录个人信息](0053-dingtalk-retrieve-user-information.md)接口获取unionId参数值。 |
