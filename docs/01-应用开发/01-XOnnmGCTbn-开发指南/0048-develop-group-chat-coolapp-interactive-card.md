...
2. 调用服务端API-[创建并投放卡片](../02-4a8AMF6u2A-服务端-API/0784-create-and-deliver-cards.md)，实现互动卡片的发送。
...
2. 调用服务端API-[创建并投放卡片](../02-4a8AMF6u2A-服务端-API/0784-create-and-deliver-cards.md)，实现互动卡片的发送。![2](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0521872871/p435568.png)
