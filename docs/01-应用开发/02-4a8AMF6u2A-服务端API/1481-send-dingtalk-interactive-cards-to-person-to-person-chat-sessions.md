...
| openConversationId | String | 否 | 会话ID，可通过[批量安装酷应用到单聊会话](../03-Ogu5SlPY4t-客户端JSAPI/0277-batch-chat-session.md)或监听[单聊酷应用事件](../04-LFcRvVD08N-事件订阅/0372-one-on-one-chat-cool-application-extension-event.md)获取`OpenConversationId`参数值。 |
