...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 文档/文件 > 钉盘 > 文件管理 > 添加文件（夹）
...
>   - **添加文件夹**：使用[添加文件夹](0653-add-folder.md)接口。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| spaceId | String | 是 | 钉盘空间ID，可调用[获取空间信息](0652-get-space-information.md)接口获取spaceId参数值。 |
