...
slug: "get-a-list-of-all-contracts-for-the-process-task"
group: "应用开发"
tab: "服务端API"
breadcrumb: "行业与生态 > 生态开放 > e签宝 2.0 > 签署流程 > 获取流程任务的所有合同列表"
doc_id: "DAQOo4r9F8"
updated_at: "2025-09-23 19:21:47"
---

> Source: https://open.dingtalk.com/document/development/get-a-list-of-all-contracts-for-the-process-task
> Path: 应用开发 / 服务端API / 行业与生态 > 生态开放 > e签宝 2.0 > 签署流程 > 获取流程任务的所有合同列表
> Updated: 2025-09-23 19:21:47
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v2.0/esign/flowTasks/{taskId}/docs |
| HTTP Method | GET |
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        getFlowDocsHeaders.xAcsDingtalkAccessToken = "<your access token>";
        try {
            client.getFlowDocsWithOptions("PRO-68E5B7", getFlowDocsHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_flow_docs_headers = dingtalkesign__2__0_models.GetFlowDocsHeaders()
        get_flow_docs_headers.x_acs_dingtalk_access_token = '<your access token>'
        try:
            client.get_flow_docs_with_options('PRO-68E5B7', get_flow_docs_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        get_flow_docs_headers.x_acs_dingtalk_access_token = '<your access token>'
        try:
            await client.get_flow_docs_with_options_async('PRO-68E5B7', get_flow_docs_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getFlowDocsHeaders = new GetFlowDocsHeaders([]);
        $getFlowDocsHeaders->xAcsDingtalkAccessToken = "<your access token>";
        try {
            $client->getFlowDocsWithOptions("PRO-68E5B7", $getFlowDocsHeaders, new RuntimeOptions([]));
        }
...
func _main (args []*string) (_err error) {
  ...
  getFlowDocsHeaders := &dingtalkesign_2_0.GetFlowDocsHeaders{}
  getFlowDocsHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetFlowDocsWithOptions(tea.String("PRO-68E5B7"), getFlowDocsHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getFlowDocsHeaders = new $dingtalkesign_2_0.GetFlowDocsHeaders({ });
    getFlowDocsHeaders.xAcsDingtalkAccessToken = "<your access token>";
    try {
      await client.getFlowDocsWithOptions("PRO-68E5B7", getFlowDocsHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkesign_2_0.Models.GetFlowDocsHeaders getFlowDocsHeaders = new AlibabaCloud.SDK.Dingtalkesign_2_0.Models.GetFlowDocsHeaders();
            getFlowDocsHeaders.XAcsDingtalkAccessToken = "<your access token>";
            try
            {
                client.GetFlowDocsWithOptions("PRO-68E5B7", getFlowDocsHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkesign_2_0::GetFlowDocsHeaders> getFlowDocsHeaders = make_shared<Alibabacloud_Dingtalkesign_2_0::GetFlowDocsHeaders>();
  getFlowDocsHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  try {
    client->getFlowDocsWithOptions(make_shared<string>("PRO-68E5B7"), getFlowDocsHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
