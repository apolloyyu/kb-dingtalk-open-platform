...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| spaceId | String | 是 | 知识库ID，调用[新建知识库](1587-create-a-team-space.md)接口或者[查询用户有权限的知识库列表](1589-querying-the-list-of-user-team-spaces.md)接口获取的workspaceId字段值。 |
| dentryId | String | 是 | 节点ID，调用[查询知识库下的目录结构](1594-query-the-directory-tree-in-the-knowledge-base.md)接口获取DentryModel参数值。 |
