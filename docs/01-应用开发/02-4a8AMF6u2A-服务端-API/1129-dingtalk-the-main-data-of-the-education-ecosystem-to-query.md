...
> Path: 应用开发 / 服务端 API / 行业与生态 > 行业开放 > 新教育 > 通用基础 > 获取学段元数据列表
...
| level | Number | 否 | 1 | 层级。 |
| parent\_id | Number | 否 | 1 | 父ID，调用[获取部门列表](1157-obtains-the-department-node-list.md)接口获取dept\_type为period时的dept\_id参数值。 |
