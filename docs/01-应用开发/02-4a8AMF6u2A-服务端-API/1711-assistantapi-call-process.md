...
doc_id: "gybGAfgLmX"
updated_at: "2026-08-27 14:02:34"
---

> Source: https://open.dingtalk.com/document/development/assistantapi-call-process
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > AI 助理 > Assistant API 调用流程
> Updated: 2026-08-27 14:02:34
...
具体信息参考[创建线程](1714-api-createassistantthread.md)文档

### **步骤二:添加Message到Thread中**

用户的Query的信息可以通过Message传入，可以创建一个Message给到指定的线程（Thread）；

具体信息参考[创建消息](1717-api-createassistantmessage.md)文档
...
- [创建AI助理的运行任务](1721-api-createassistantrun.md)文档
- [获取AI助理的运行任务](1722-api-retrieveassistantrun.md)文档
- [获取AI助理的消息列表](1719-api-listassistantmessage.md)文档
...
**接入参考文档：**[创建AI助理的运行任务](1721-api-createassistantrun.md)文档。
