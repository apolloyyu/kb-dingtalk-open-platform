...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 培训 > 获取培训课程的基本信息
...
> - 未接入的开发者建议使用新版[查询直播信息](0430-queries-the-live-streaming-information.md)接口，已接入用户不受影响。
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| feed\_id | String | 是 | c6277-a538-466xxxx | 课程ID，可通过[创建培训课程](1678-create-live-courses.md)接口获取。 |
