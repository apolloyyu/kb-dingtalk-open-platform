...
> Path: 应用开发 / 服务端 API / OA 审批 > 官方 OA 审批 > 审批钉盘空间&附件 > 授权预览审批附件
...
| agentId | Long | 否 | 应用的agentId：   - 企业内部应用，可查看[AgentId](https://open.dingtalk.com/document/development/development-basic-concepts#884d363067bnq)信息。 - 第三方企业应用，可调用[获取企业授权信息](0041-obtains-the-basic-information-of-an-enterprise.md)接口获取`agentid`参数值。 |
