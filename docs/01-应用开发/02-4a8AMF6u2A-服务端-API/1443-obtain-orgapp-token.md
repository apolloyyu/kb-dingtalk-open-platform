...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 获取访问凭证 > 获取企业内部应用的access_token
...
> - 未接入的开发者建议使用新版 [获取企业内部应用的accessToken](0032-obtain-the-access-token-of-an-internal-app.md)接口，已接入用户不受影响。
