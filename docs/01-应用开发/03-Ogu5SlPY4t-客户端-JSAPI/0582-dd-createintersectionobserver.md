...
group: "应用开发"
tab: "客户端 JSAPI"
breadcrumb: "历史文档（不推荐） > 小程序 > 节点查询 > IntersectionObserver > 创建IntersectionObserver对象实例"
doc_id: "BHI34HkkNt"
updated_at: "2026-09-01 09:16:44"
---

> Source: https://open.dingtalk.com/document/development/dd-createintersectionobserver
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 节点查询 > IntersectionObserver > 创建IntersectionObserver对象实例
> Updated: 2026-09-01 09:16:44
...
[IntersectionObserver](0583-overview-of-intersectionobserver.md)
