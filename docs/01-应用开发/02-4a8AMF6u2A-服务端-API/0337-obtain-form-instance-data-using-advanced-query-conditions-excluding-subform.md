...
> Path: 应用开发 / 服务端 API / 宜搭 > 表单 > 通过高级查询条件获取表单实例数据（不包括子表单组件数据）
> Updated: 2026-06-03 10:11:50
...
| originatorId | String | 否 | 表单实例提交人的userId，可通过[获取部门用户userid列表](0064-query-the-list-of-department-userids.md)接口获取。 |
