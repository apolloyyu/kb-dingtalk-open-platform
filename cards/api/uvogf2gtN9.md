...
archived: false
method: POST
endpoint: https://oapi.dingtalk.com/topapi/attendance/group/positions/query
api_version: v1-oapi
app_types: 企业内部应用
...
## Returns
- optional: result(DingOpenResult), position_list(Position[]), offset(Number), address(String), latitude(String), longitude(String), position_key(String), has_more(Boolean), errcode(Number), errmsg(String), success(Boolean), request_id(String)
