...
| group\_id | Number | 685935028 | 考勤组ID。  **[!NOTE]**  如果你使用的是旧考勤组标识**group\_key**，可通过[groupKey转换为groupId](0175-convert-groupkey-to-groupid.md)接口将**group\_key**转换为**group\_id**。 |
