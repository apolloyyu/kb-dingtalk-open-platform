...
| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [获取用户签到记录](0289-obtain-the-check-in-records-of-multiple-users.md) | 获取用户签到记录。 | 旧版 |
| [获取部门用户签到记录](0290-get-check-in-data.md) | 以部门维度获取员工签到记录。 | 旧版 |
...
钉钉提供了签到接口接入流程示例，请参见[获取员工签到信息](0288-obtain-check-in-information.md)。
