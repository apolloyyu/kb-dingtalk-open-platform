...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 协同办公 > 公告 > 获取公告详情
...
> - 未接入的开发者建议使用新版[获取公告详情](0281-obtains-the-details-get-blackboard.md)接口，已接入用户不受影响。
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| blackboard\_id | String | 是 | 9uiuihhgui989huh | 公告id，可以通过[获取公告ID列表](0282-obtains-the-id-list-of-announcements-that-are-not-deleted.md)接口获取id参数值。 |
