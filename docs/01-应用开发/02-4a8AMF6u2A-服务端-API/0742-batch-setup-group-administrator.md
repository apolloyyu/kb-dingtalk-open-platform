...
> Path: 应用开发 / 服务端 API / 即时通信 > 会话管理 > 群管理 > 批量设置企业群管理员
...
| userIds | Array of String | 是 | 企业员工userid列表。可以调用[获取部门用户userid列表](0064-query-the-list-of-department-userids.md)接口获取userid\_list参数值。 |
