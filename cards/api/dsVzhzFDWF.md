...
archived: false
method: POST
endpoint: https://api.dingtalk.com/v1.0/doc/workbooks/{workbookId}/sheets/{sheetId}/filterViews/{filterViewId}/clearColumnFilterCriteria
api_version: v2-new
app_types: 企业内部应用
...
## Body
- column (Long, required): 列偏移量，相对于筛选视图范围首列，从 0 开始。例如筛选视图范围为 `B1:E10`，则 `column=0` 代表 B 列，`column=1` 代表 C 列。
...
updated_at: 2026-06-04 19:09:25
