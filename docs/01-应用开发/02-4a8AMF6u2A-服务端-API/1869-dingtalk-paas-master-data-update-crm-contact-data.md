...
> - 未接入的开发者建议使用新版[批量修改联系人数据](1360-modify-contact-data-in-batches.md)接口，已接入用户不受影响。
...
| instance\_id | String | 是 | instance\_id | 联系人数据ID，可通过[根据指定条件查询联系人数据](1876-dingtalk-the-contact-data-query-api.md)接口获取。 |
