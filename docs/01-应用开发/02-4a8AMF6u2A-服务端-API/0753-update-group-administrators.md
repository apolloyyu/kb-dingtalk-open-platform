...
> Path: 应用开发 / 服务端 API / 即时通信 > 会话管理 > 场景群 > 群管理 > 更新场景群管理员
> Updated: 2026-08-14 09:41:54
...
支持基于群模板创建的群，详情参见[创建场景群](0747-create-a-scene-group.md)。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| openConversationId | String | 是 | 群ID，调用[创建场景群](0747-create-a-scene-group.md)接口获取`open_conversation_id`参数值。 |
