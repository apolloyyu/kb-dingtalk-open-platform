...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 获取访问凭证 > 获取第三方企业应用的suite_access_token
...
> - 未接入的开发者建议使用新版 [获取第三方企业应用的suiteAccessToken](0035-obtains-the-suite-acess-token-of-third-party-enterprise-applications.md)接口，已接入用户不受影响。

该suite\_access\_token主要用于获取第三方企业应用的信息，在调用以下接口时会使用第三方企业应用的suite\_access\_token：

- [获取授权应用的基本信息](0042-obtains-application-information-of-an-enterprise.md)
- [获取企业授权信息](0041-obtains-the-basic-information-of-an-enterprise.md)
