...
doc_id: "dYSEc9avSG"
updated_at: "2025-12-08 10:34:30"
---

> Source: https://open.dingtalk.com/document/development/get-details-of-the-video-conference
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 数据目录 > 数据统计 > 视频会议统计 > 获取视频会议详情
> Updated: 2025-12-08 10:34:30
...
![](https://img.alicdn.com/imgextra/i3/O1CN018WALI01jMA91W4jao_!!6000000004533-2-tps-2768-1224.png)
...
| --- | --- | --- | --- |
| 企业内部应用 | 支持 | 专属钉钉专属数据读权限 | **[!IMPORTANT]**  暂不支持新增申请。 |
| 第三方企业应用 | 支持 | 专属钉钉专属数据读权限 | **[!IMPORTANT]**  暂不支持新增申请。 |
