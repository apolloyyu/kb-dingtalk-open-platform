...
> Path: 应用开发 / 服务端 API / 即时通信 > 会话管理 > 群管理 > 查询群信息
...
| chatid | String | 是 | chate39f540dxxxx | 群会话的ID。   - 仅支持通过调用服务端[创建群会话](0739-create-common-group-new-version-v2.md)接口获取的chatid参数值。 - 不支持通过调用前端JSAPI获取的chatid。 |
