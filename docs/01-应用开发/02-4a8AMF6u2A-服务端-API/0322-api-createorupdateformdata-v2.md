...
> Path: 应用开发 / 服务端 API / 宜搭 > 表单 > 新增或更新表单实例
...
| searchCondition | String | 是 | 用于检索表单实例数据的检索条件，格式参考[表单筛选组件格式](0366-instructions-for-creating-or-updating-form-data-format.md)。 |
| appType | String | 是 | 应用编码，获取方式可参考下图所示： |
| formDataJson | String | 是 | 用于更新或新增表单实例的数据，格式参考[创建或更新表单数据格式](0366-instructions-for-creating-or-updating-form-data-format.md)。 |
