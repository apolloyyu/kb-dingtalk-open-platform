...
archived: false
method: GET
endpoint: https://api.dingtalk.com/v1.0/calendar/users/{userId}/calendars/{calendarId}/eventsview
api_version: v2-new
app_types: 第三方个人应用
...
## Path params
- userId (String, required): 要查询的用户unionId。 - 企业内部应用和第三方企业应用，调用查询用户详情接口获取unionid参数值。 - 第三方个人应用，调用获取用户通讯录个人信息接口获取unionId参数值。
- calendarId (String, required): 日程所属的日历ID，调用查询日历接口查询当前用户日程，使用**primary**关键字，表示当前用户的主日历。

## Query params
- optional: timeMin(String), timeMax(String), maxResults(Integer), maxAttendees(Integer), nextToken(String)

## Body
- none

## Returns
- optional: nextToken(String), events(Array), id(String), summary(String), description(String), start(Object), date(String), dateTime(String), timeZone(String), originStart(Object), end(Object), isAllDay(Boolean), recurrence(Object), pattern(Object), type(String), dayOfMonth(Integer), daysOfWeek(String), index(String), interval(Integer), firstDayOfWeek(String), range(Object), endDate(String), numberOfOccurrences(Integer), attendees(Array), displayName(String), responseStatus(String), self(Boolean), isOptional(Boolean), organizer(Object), location(Object), meetingRooms(Array of String), seriesMasterId(String), createTime(String), updateTime(String), status(String), extendedProperties(Object), sharedProperties(Object), sourceOpenCid(String), belongCorpId(String), privateProperties(Object), dingtalkDetailUrl(String), onlineMeetingInfo(Object), conferenceId(String), url(String), extraInfo(Map), categories(Array), richTextDescription(Object), text(String), roomId(String)
