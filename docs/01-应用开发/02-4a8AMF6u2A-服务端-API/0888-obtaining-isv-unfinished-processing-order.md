...
> Path: 应用开发 / 服务端 API / 应用市场 > 应用内购 > 获取未处理的已支付订单
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| access\_token | String | 是 | 6d1bxxxx | 调用服务端接口的授权凭证，可调用[获取第三方企业应用的suite\_access\_token](1448-obtain-application-suite-ticket.md)接口获得。 |
