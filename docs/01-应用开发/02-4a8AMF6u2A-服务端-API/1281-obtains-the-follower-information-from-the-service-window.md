...
| accountId | String | 否 | 服务窗账号ID，通过[获取企业下服务窗列表](1279-queries-the-list-of-services-under-an-enterprise.md)接口获取。  **[!NOTE]**   - 服务窗应用场景下，该参数不传，否则会报错非法请求。 - 非服务窗应用场景下，该参数必填，否则会报错非法服务窗账号。 |
