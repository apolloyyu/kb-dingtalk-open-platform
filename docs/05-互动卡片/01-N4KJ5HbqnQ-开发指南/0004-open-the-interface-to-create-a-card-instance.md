...
详情参见[创建卡片](../../01-应用开发/02-4a8AMF6u2A-服务端-API/0781-interface-for-creating-a-card-instance.md)接口。
...
- 通过服务端API-[创建卡片](../../01-应用开发/02-4a8AMF6u2A-服务端-API/0781-interface-for-creating-a-card-instance.md)接口，实现场域的添加。
- 通过服务端API-[新增或者更新卡片的场域信息](../../01-应用开发/02-4a8AMF6u2A-服务端-API/0788-add-field-interface.md)接口，实现对场域信息的添加和更新操作，详情参见[开放接口投放卡片实例](0006-open-interface-card-delivery-instance.md)。
...
调用服务端API-[创建卡片](../../01-应用开发/02-4a8AMF6u2A-服务端-API/0781-interface-for-creating-a-card-instance.md)接口实现卡片实例的创建。
...
> **[!NOTE]**
>
> - 卡片非 String 类型属性的填写请参考：[API 卡片数据的填写说明](../../01-应用开发/02-4a8AMF6u2A-服务端-API/0790-instructions-for-filling-in-api-card-data.md)。
> - `userIdType` 字段的填写请参考：[卡片数据与参数配置-userIdType 字段的填写说明](../../01-应用开发/02-4a8AMF6u2A-服务端-API/0791-faq-card.md#8607bdd785avq)。
> - 总大小控制在100KB以内
