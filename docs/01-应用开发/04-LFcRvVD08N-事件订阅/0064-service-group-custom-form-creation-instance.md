...
doc_id: "NJgyjTDQax"
updated_at: "2025-08-28 19:46:14"
---
...
- `data.spiCrmModel.formScene`（string）：表单实例场景： - DING\_CUSTOMER：客户实例 - DING\_CONTACT：联系人实例 - DING\_JOIN\_GROUP：入群表单实例
...
- `data.spiCrmModel.formData.customerType`（integer）：客户类型。
- `data.spiCrmModel.formData.customerName`（string）：客户名称。
...
- `spiCrmModel.formScene`（string）：表单实例场景： - DING\_CUSTOMER：客户实例 - DING\_CONTACT：联系人实例 - DING\_JOIN\_GROUP：入群表单实例
...
- `spiCrmModel.formData.customer_type`（integer）：客户类型。
- `spiCrmModel.formData.customer_name`（string）：客户名称。
