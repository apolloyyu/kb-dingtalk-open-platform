...
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 即时通信 > 会话管理 > 场景群 > 更新群
...
> - 未接入的开发者建议使用新版[更新场景群](0748-api-updatescenegroup.md)接口，已接入用户不受影响。
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| open\_conversation\_id | String | 是 | cidt\*\*\*\*\*Xa4K10w== | 群ID，调用[创建群](1487-create-a-scene-group-v2.md)接口获取`open_conversation_id`参数值。 |
