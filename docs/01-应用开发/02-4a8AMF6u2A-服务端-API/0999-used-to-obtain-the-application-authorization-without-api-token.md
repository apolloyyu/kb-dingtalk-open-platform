...
> Path: 应用开发 / 服务端 API / 钉钉工作台 > 获取工作台API访问凭证
...
- [获取工作台插件权限点](1001-obtain-the-permissions-of-the-workbench-plug-in.md)
- [批量添加最近使用应用](1000-add-recently-used-apps-in-bulk.md)
- [获取工作台插件检验的规则信息](1002-you-can-call-this-operation-to-obtain-the-information-about.md)
