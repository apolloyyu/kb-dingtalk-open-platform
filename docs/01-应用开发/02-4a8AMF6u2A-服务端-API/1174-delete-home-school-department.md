...
> Path: 应用开发 / 服务端 API / 行业与生态 > 行业开放 > 新教育 > 家校通讯录2.0 > 删除家校部门
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| deptId | Long | 是 | 部门ID，可调用[获取部门列表](1153-obtains-the-department-node-list.md)接口获取dept\_type为class时的dept\_id参数值。 |
