...
doc_id: "sykrin2RlO"
updated_at: "2026-08-27 14:04:37"
---

> Source: https://open.dingtalk.com/document/development/api-updateassistantbasicinfo
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > AI 助理 > 助理管理 > 更新AI助理基础信息
> Updated: 2026-08-27 14:04:37
...
| icon | String | 否 | 助理头像，采用钉钉多媒体文件标识符 Media ID 表示，调用[上传媒体文件](0645-upload-media-files.md)接口获取钉钉多媒体文件标识符 Media ID参数值。 |
