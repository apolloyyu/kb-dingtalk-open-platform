...
doc_id: "o61tsQEhWK"
updated_at: "2026-08-27 14:03:03"
---

> Source: https://open.dingtalk.com/document/development/api-assistantmeresponse
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > AI 助理 > 响应 > AI助理响应接口-个人权限
> Updated: 2026-08-27 14:03:03
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| assistantId | String | 否 | 助理 ID，可调用[获取用户创建的AI助理列表](1729-assistant-acquires-list-assistants-created-by-users.md)接口获取助理 ID。 |
