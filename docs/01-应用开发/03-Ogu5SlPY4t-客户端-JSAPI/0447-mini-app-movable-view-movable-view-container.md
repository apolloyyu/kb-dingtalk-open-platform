...
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 基础组件 > 视图容器 > movable-view 可移动视图容器
...
**movable-view** 可移动的视图容器，在页面中可以拖拽滑动。movable-view 必须在[movable-area 可移动视图区域](0448-mini-app-movable-area-movable-view-area.md) 组件中，并且必须是直接子节点，否则不能移动。
