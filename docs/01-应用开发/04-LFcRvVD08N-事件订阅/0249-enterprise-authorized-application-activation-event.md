---
title: "企业授权开通应用事件"
source_url: "https://open.dingtalk.com/document/development/enterprise-authorized-application-activation-event"
namespace: "development"
slug: "enterprise-authorized-application-activation-event"
group: "应用开发"
tab: "事件订阅"
breadcrumb: "历史文档（不推荐） > HTTP回调 > 事件列表 > 企业授权开通应用事件"
doc_id: "KQDQaWs4FY"
updated_at: "2025-10-16 14:31:44"
---

> Source: https://open.dingtalk.com/document/development/enterprise-authorized-application-activation-event
> Path: 应用开发 / 事件订阅 / 历史文档（不推荐） > HTTP回调 > 事件列表 > 企业授权开通应用事件
> Updated: 2025-10-16 14:31:44
