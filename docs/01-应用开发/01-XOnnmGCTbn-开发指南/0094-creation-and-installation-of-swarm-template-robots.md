...
3. 配置群机器人信息：
   ...
   | 消息回调地址 | 当群内用户 @ 群机器人并发送消息时，该消息可以通过消息回调地址发送到开发者的服务器，必须是公网可访问地址。  例如：  https://example.com/callback  机器人接收消息类型和数据格式，详情参考[消息发送与接收类型](../02-4a8AMF6u2A-服务端-API/0700-robot-message-type.md)。 |
...
创建完成后，你需要将群模板机器人关联到群模板中，详情参考[关联群模板机器人到群模板](0099-associate-group-template-robot-to-group-template.md)。
