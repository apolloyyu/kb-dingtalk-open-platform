...
> Path: 应用开发 / 服务端 API / 考勤 > 假勤审批 > 通知审批撤销
...
当调用[通知审批通过](0225-api-processapprovefinish.md)接口之后，由于各种原因提交的审批单需要被撤销时，需要调用本接口撤销修改的考勤记录。
...
| approve\_id | String | 是 | 2376620852 | 审批ID，来自[通知审批通过](0225-api-processapprovefinish.md)接口自定义的参数approve\_id。 |
