...
| userIds | Array of String | 是 | 接收消息的用户userId列表，每次最多传20个，可通过[查询用户详情](0055-query-user-details.md)或[获取部门用户userid列表](0064-query-the-list-of-department-userids.md)接口获取。 |
