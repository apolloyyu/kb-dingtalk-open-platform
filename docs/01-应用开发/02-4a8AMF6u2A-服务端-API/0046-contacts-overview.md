...
| API | 说明 | API 版本 |
| --- | --- | --- |
| [获取用户通讯录个人信息](0053-dingtalk-retrieve-user-information.md) | 获取企业用户通讯录中的个人信息。 | 新版 |

#### **通讯录权限**

| API | 说明 | API 版本 |
| --- | --- | --- |
| [获取通讯录权限范围](0052-obtain-corpsecret-authorization-scope.md) | 获取通讯录权限范围。 | 旧版 |

#### **用户管理**

| API | API说明 | API 版本 |
| --- | --- | --- |
| [创建用户](0054-user-information-creation.md) | 创建新用户。 | 旧版 |
| [更新用户信息](0056-user-information-update.md) | 更新指定的用户信息。 | 旧版 |
| [删除用户](0057-delete-a-user.md) | 根据用户的userid删除指定用户。 | 旧版 |
| [查询用户详情](0055-query-user-details.md) | 获取指定用户的详细信息。 | 旧版 |
| [获取部门用户基础信息](0065-queries-the-simple-information-of-a-department-user.md) | 获取指定部门的用户基础信息。 | 旧版 |
| [获取部门用户userid列表](0064-query-the-list-of-department-userids.md) | 获取指定部门的userid列表。 | 旧版 |
| [获取部门用户详情](0061-queries-the-complete-information-of-a-department-user.md) | 获取指定部门中的用户详细信息。 | 旧版 |
| [获取员工人数](0058-user-management-acquires-number-employees.md) | 获取员工人数。 | 旧版 |
| [获取未登录钉钉的员工列表](0066-queries-the-inactive-users-or-active-users-under-an-enterprise.md) | 查询指定日期内未登录钉钉的企业员工列表。 | 旧版 |
| [根据手机号查询用户](0062-query-users-by-phone-number.md) | 根据手机号获取用户的userId。 | 旧版 |
| [根据unionid获取用户userid](0063-query-a-user-by-the-union-id.md) | 根据unionid获取用户的userid。 | 旧版 |
| [获取管理员列表](0067-query-the-administrator-list.md) | 查询管理员列表。 | 旧版 |
| [获取管理员通讯录权限范围](0069-query-permissions-of-the-administrator-address-book.md) | 获取管理员通讯录权限范围。 | 旧版 |
| [获取管理员的应用管理权限](0068-obtains-the-administrator-s-microapplication-management-permission.md) | 获取管理员的应用管理权限。 | 旧版 |
| [查询离职记录列表](0072-query-the-details-of-employees-who-have-left-office.md) | 查询企业离职记录列表。 | 新版 |
| [设置高管模式](0070-update-executive-settings.md) | 设置员工的高管模式。 | 新版 |
| [获取用户高管模式设置](0071-get-user-executive-mode-settings.md) | 获取用户高管模式的设置详情。 | 新版 |
| [删除用户属性可见性设置](0075-delete-enterprise-employee-attribute-field-visibility-settings.md) | 删除企业员工属性字段可见性设置。 | 新版 |
| [获取用户属性可见性设置](0074-pull-hidden-property-field-for-enterprise-employees.md) | 获取企业员工属性字段隐藏设置。 | 新版 |
| [设置用户属性可见性](0073-add-or-update-the-hidden-settings-of-the-employee-property.md) | 新增或更新企业员工属性字段隐藏设置。 | 新版 |
| [搜索用户userId](0059-address-book-search-user-id.md) | 根据用户名称搜索用户userId。 | 新版 |
| [通讯录userId排序](0060-address-book-userid-sorting.md) | 根据用户姓名拼音进行userId排序。 | 新版 |

#### **部门管理**

| API | 说明 | API 版本 |
| --- | --- | --- |
| [创建部门](0076-address-book-creation-department-established-department.md) | 创建新部门。 | 旧版 |
| [更新部门](0077-address-book-update-department.md) | 更新部门信息。 | 旧版 |
| [删除部门](0078-address-book-deletion-department.md) | 根据部门ID删除指定部门。 | 旧版 |
| [搜索部门ID](0079-address-book-search-department-id.md) | 搜索部门ID。 | 新版 |
| [获取部门详情](0080-query-department-details0-v2.md) | 根据部门ID获取指定部门详情。 | 旧版 |
| [获取部门列表](0081-user-management-acquires-the-list-departments.md) | 获取下一级部门基础信息。 | 旧版 |
| [获取子部门ID列表](0082-obtain-the-list-of-sub-department-ids.md) | 获取企业部门下的所有直属子部门列表。 | 旧版 |
| [获取指定部门的所有父部门列表](0083-query-the-list-of-all-parent-departments-of-a-department.md) | 获取指定部门的所有父部门ID列表。 | 旧版 |
| [获取指定用户的所有父部门列表](0084-queries-the-list-of-all-parent-departments-of-a-user.md) | 查询指定用户所属的所有父级部门。 | 旧版 |

#### **角色管理**

| API | 说明 | API 版本 |
| --- | --- | --- |
| [创建角色](0085-address-book-add-role.md) | 创建新角色。 | 旧版 |
| [创建角色组](0090-add-a-role-group.md) | 创建角色组。 | 旧版 |
| [更新角色名称](0087-update-the-character-name.md) | 更新角色名称。 | 旧版 |
| [批量增加员工角色](0092-add-role-information-to-employees-in-batches.md) | 批量增加员工角色。 | 旧版 |
| [删除角色](0086-delete-role-information.md) | 根据角色ID删除指定的角色。 | 旧版 |
| [批量删除员工角色](0093-delete-the-color-information-of-employee-corners-in-batches.md) | 批量删除员工的角色。 | 旧版 |
| [设定角色成员管理范围](0094-update-role-member-management-department-scope.md) | 设定角色成员管理范围。 | 旧版 |
| [获取角色组列表](0091-obtains-the-role-group-information.md) | 获取角色组信息。 | 旧版 |
| [获取角色列表](0088-obtains-a-list-of-enterprise-roles.md) | 获取角色列表。 | 旧版 |
| [获取角色详情](0089-queries-role-details.md) | 根据角色ID获取指定角色详情。 | 旧版 |
| [获取指定角色的员工列表](0095-obtain-the-list-of-employees-of-a-role.md) | 获取指定角色的员工列表。 | 旧版 |

#### **外部联系人**

| API | 说明 | API 版本 |
| --- | --- | --- |
| [添加外部联系人](0096-add-enterprise-external-contacts.md) | 添加企业外部联系人。 | 旧版 |
| [删除外部联系人](0097-delete-external-contact.md) | 删除企业外部联系人。 | 旧版 |
| [更新外部联系人](0098-update-enterprise-external-contacts.md) | 更新企业外部联系人。 | 旧版 |
| [获取外部联系人列表](0099-obtain-the-external-contact-list.md) | 获取企业外部联系人列表。 | 旧版 |
| [获取外部联系人标签列表](0100-obtains-a-list-of-external-contact-tags.md) | 获取企业外部联系人的标签。 | 旧版 |
| [获取外部联系人详情](0101-obtains-the-external-contact-details-of-an-enterprise.md) | 获取企业外部联系人的详细信息。 | 旧版 |

#### **企业账号**

| API | 说明 | API 版本 |
| --- | --- | --- |
| [创建SSO企业账号](0103-create-an-sso-account.md) | 创建SSO企业账号新用户。 | 旧版 |
| [企业账号修改钉钉号](0104-api-changedingtalkid.md) | 修改企业账号钉钉号。 | 新版 |
| [创建钉钉自建企业账号](0105-create-dingtalk-user-created-dedicated-account.md) | 创建钉钉自建企业账号新用户。 | 旧版 |
| [更新企业账号用户信息](0106-update-dedicated-accounts-information.md) | 更新指定的企业账号用户信息。 | 旧版 |
| [查询企业账号用户详情](0107-queries-the-details-of-a-dedicated-account.md) | 获取指定企业账号用户的详细信息。 | 旧版 |
| [启用企业账号](0108-enable-a-dedicated-account.md) | 启用指定企业账号。 | 新版 |
...
- [创建、获取、更新和删除企业员工](0047-address-book-employee-operations.md)
- [创建、获取、更新和删除企业部门](0048-operations-related-to-address-book-departments.md)
- [企业OA系统与钉钉通讯录实现同步](0049-synchronization-between-enterprise-oa-system-and-dingtalk-address-book.md)
- [第三方个人小程序获取登录用户信息](0050-third-party-personal-applet-to-obtain-login-user-information-tutorial.md)
...
unionId可通过调用[查询用户详情](0055-query-user-details.md)接口获取。
