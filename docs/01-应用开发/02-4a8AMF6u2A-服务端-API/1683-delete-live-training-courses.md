...
doc_id: "7noLJhsGWQ"
updated_at: "2026-08-27 12:32:13"
---

> Source: https://open.dingtalk.com/document/development/delete-live-training-courses
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 培训 > 删除培训课程
> Updated: 2026-08-27 12:32:13
...
> - 未接入的开发者建议使用新版[删除直播](0430-delete-live-streaming.md)接口，已接入用户不受影响。
