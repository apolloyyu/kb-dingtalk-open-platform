...
group: "应用开发"
tab: "客户端 JSAPI"
breadcrumb: "历史文档（不推荐） > 小程序 > 节点查询 > SelectorQuery > 创建SelectorQuery节点查询对象"
doc_id: "gg11j5NpLI"
updated_at: "2026-09-01 09:16:45"
---

> Source: https://open.dingtalk.com/document/development/dd-createselectorquery
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > 小程序 > 节点查询 > SelectorQuery > 创建SelectorQuery节点查询对象
...
[SelectorQuery](0585-selectorquery.md)
