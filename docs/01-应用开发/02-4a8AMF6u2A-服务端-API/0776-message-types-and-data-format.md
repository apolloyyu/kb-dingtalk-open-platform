...
| link.messageUrl | String | 是 | http://dingtalk.com | 消息点击链接地址，当发送消息为小程序时支持小程序跳转链接，请参考[消息链接说明](0777-message-link-description.md)。 |
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| oa.message\_url | String | 是 | http://dingtalk.com | 消息点击链接地址，当发送消息为小程序时支持小程序跳转链接，请参考[消息链接说明](0777-message-link-description.md)。 |
...
| oa.head.text | String | 是 | 头部标题 | 消息的头部标题。如果是[发送工作通知](0770-asynchronous-sending-of-enterprise-session-messages.md)消息，该参数会被替换为当前应用名称。 |
