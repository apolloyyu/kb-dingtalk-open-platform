...
> - 未接入的开发者建议使用新版[发起审批实例](0496-create-an-approval-instance.md)接口，已接入用户不受影响。
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| suite\_access\_token | String | 是 | 6d1bxxxx | 调用服务端API授权凭证，可通过[获取第三方企业应用的suite\_access\_token](1444-obtain-application-suite-ticket.md)接口获取。 |
