...
1. 参会人员使用钉钉-签到应用进行签到。
2. 调用服务端API-[获取用户签到记录](0289-obtain-the-check-in-records-of-multiple-users.md)接口，获取员工的签到详情信息。
...
2. 根据员工的userId，调用服务端API-[获取用户签到记录](0289-obtain-the-check-in-records-of-multiple-users.md)接口，获取员工签到的详情信息。
