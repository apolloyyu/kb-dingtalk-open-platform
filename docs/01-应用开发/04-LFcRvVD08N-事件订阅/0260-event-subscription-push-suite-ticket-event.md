...
source_url: "https://open.dingtalk.com/document/development/event-subscription-push-suite-ticket-event"
namespace: "development"
slug: "event-subscription-push-suite-ticket-event"
group: "应用开发"
tab: "事件订阅"
breadcrumb: "历史文档（不推荐） > HTTP回调 > 通用回调事件 > 推送suite_ticket事件"
doc_id: "JUy9NrlwJf"
updated_at: "2025-12-08 15:27:10"
---

> Source: https://open.dingtalk.com/document/development/event-subscription-push-suite-ticket-event
> Path: 应用开发 / 事件订阅 / 历史文档（不推荐） > HTTP回调 > 通用回调事件 > 推送suite_ticket事件
> Updated: 2025-12-08 15:27:10
