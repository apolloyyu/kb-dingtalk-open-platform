...
> Path: 应用开发 / 服务端 API / Teambition 项目管理 > 任务 > 项目任务 > 搜索任务工作流状态
...
| projectId | String | 是 | 项目ID，可通过调用[根据项目模板创建项目](1218-create-a-project-from-a-project-template.md)接口，获取返回参数`id`字段值。 |
