...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| chatid | String | 是 | chat14432xxxx | 群会话ID，可通过[创建群](1480-session-management-creates-groups.md)接口获取chatid参数值。 |
| userids | String | 是 | userid1 | 群成员userId，可通过[根据手机号查询用户](0062-query-users-by-phone-number.md)接口获取userId参数值。 |
