...
| taskId | Long | 是 | 任务ID，可调用[获取单个审批实例详情](0497-obtains-the-details-of-a-single-approval-instance-pop.md)接口获取`taskId`参数值。 |
...
| actionerUserId | String | 是 | 实际执行人用户ID，可通过调用[获取单个审批实例详情](0497-obtains-the-details-of-a-single-approval-instance-pop.md)接口获取。 |
