...
> - 未接入的开发者建议使用新版[新增或更新表单实例](0323-api-createorupdateformdata-v2.md)接口，已接入用户不受影响。
...
| searchCondition | String | 是 | 用于检索表单实例数据的检索条件，格式参考[表单筛选组件格式](0367-instructions-for-creating-or-updating-form-data-format.md#d902d581d1k3s) |
| appType | String | 是 | 宜搭应用编码。  **[!NOTE]**    该参数从宜搭应用中获取。 |
| formDataJson | String | 是 | 用于更新或新增表单实例的数据，格式参考[创建或更新表单数据格式](0367-instructions-for-creating-or-updating-form-data-format.md#5108c67267onf)。 |
