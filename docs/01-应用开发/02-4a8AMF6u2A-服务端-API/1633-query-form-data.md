...
doc_id: "F7jKVMacZh"
updated_at: "2026-08-25 09:39:30"
---

> Source: https://open.dingtalk.com/document/development/query-form-data
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 宜搭 > 表单 > 查询表单数据
> Updated: 2026-08-25 09:39:30
...
> - 未接入的开发者建议使用新版[查询表单数据](0316-api-getformdatabyid-v2.md)接口，已接入用户不受影响。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| id | String | 否 | 表单实例ID，可通过[获取多个表单实例ID](1634-obtain-the-ids-of-multiple-form-instances.md)接口获取。 |
