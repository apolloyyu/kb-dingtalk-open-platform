...
> Path: 应用开发 / 服务端 API / 考勤 > 考勤组管理 > 查询参与考勤人员列表
...
| group\_key | String | 是 | CEDDFFxxxx | 考勤组ID。  **[!NOTE]**  如果你使用的考勤组标识是group\_id，可以调用[groupId转换为groupKey](0176-groupid-to-groupkey.md)接口将group\_id转换为group\_key。 |
