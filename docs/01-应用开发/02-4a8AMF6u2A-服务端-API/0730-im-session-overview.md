...
chatId用于唯一标识**群聊会话**，通过[创建群](1480-session-management-creates-groups.md)接口返回值获取。
...
openConversationId用于唯一识别**群聊会话**，通过[创建群](1483-create-a-scene-group-v2.md)接口返回值获取。
