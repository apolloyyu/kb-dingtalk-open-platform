...
>
>   - **添加文件**：使用[获取文件上传信息](0675-obtain-file-upload-informations.md)和[提交文件](0676-submittal-file.md)接口。
...
| mediaId | String | 否 | 对应OSS Object Key，可调用[获取文件上传信息](0675-obtain-file-upload-informations.md)接口获取。  **[!NOTE]**   - 当**fileType**值为**file**文件时，此参数必填。 - 当**fileType**值为**folder**文件夹时，此参数可不填。 |
