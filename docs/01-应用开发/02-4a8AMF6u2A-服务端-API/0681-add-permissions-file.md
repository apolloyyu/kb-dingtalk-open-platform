...
> Path: 应用开发 / 服务端 API / 文档/文件 > 存储管理 > 权限管理 > 添加权限
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| dentryUuid | String | 是 | 文件uuid：可调用[搜索文件](0637-search-for-files.md)接口或[获取dentryUuid信息](0671-api-getuuidbydentryid.md)接口，获取返回参数`dentryUuid`字段。 |
