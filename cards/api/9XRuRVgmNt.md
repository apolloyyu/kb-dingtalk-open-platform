...
archived: false
method: POST
endpoint: https://api.dingtalk.com/v1.0/doc/workbooks/{workbookId}/sheets/{sheetId}/deleteColumns
api_version: v2-new
app_types: 第三方企业应用
...
## Body
- column (Long, required): 要删除的第一列的游标，从0开始。
- columnCount (Long, required): 要删除的列的数量。
