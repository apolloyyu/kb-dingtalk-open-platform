...
doc_id: "xTDcGV4bQK"
updated_at: "2026-07-21 09:26:28"
---

> Source: https://open.dingtalk.com/document/development/open-approval-filter-page
> Path: 应用开发 / 服务端 API / 更多开放 > AppLink协议 > 已支持的协议 > 打开审批筛选页
> Updated: 2026-07-21 09:26:28
...
| processCode | String | 否 | PROC-\*\*\*\*-\*\*\*\*- | 模板code，可参考[基础概念-processCode](0472-workflow-overview.md)。 |
