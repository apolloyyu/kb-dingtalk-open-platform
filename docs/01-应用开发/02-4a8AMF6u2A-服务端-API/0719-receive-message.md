...
> Path: 应用开发 / 服务端 API / 即时通信 > 机器人 > 消息接收 > 接收消息
...
| downloadCode | String | 语音文件的下载码，用于换取下载语音的二进制文件，调用服务端API-[下载机器人接收消息的文件内容](0720-download-the-file-content-of-the-robot-receiving-message.md)接口，获取临时下载链接。 |
...
| downloadCode | String | 图片文件的下载码，用于换取下载图片的二进制文件，调用服务端API-[下载机器人接收消息的文件内容](0720-download-the-file-content-of-the-robot-receiving-message.md)接口，获取临时下载链接。 |
...
| downloadCode | String | 视频文件的下载码，用于换取下载视频的二进制文件，调用服务端API-[下载机器人接收消息的文件内容](0720-download-the-file-content-of-the-robot-receiving-message.md)接口，获取临时下载链接。 |
...
| downloadCode | String | 文件的下载码，用于换取下载文件的二进制文件，调用服务端API-[下载机器人接收消息的文件内容](0720-download-the-file-content-of-the-robot-receiving-message.md)接口，获取临时下载链接。 |
| fileName | String | 文件名。 |
...
开发者可以根据自己的业务需要，选择回复一段消息，目前支持text、markdown、整体跳转actionCard类型、独立跳转actionCard类型、feedCard这5种[消息类型](0700-robot-message-type.md)。
