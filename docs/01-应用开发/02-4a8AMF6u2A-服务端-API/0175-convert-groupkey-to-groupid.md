...
> Path: 应用开发 / 服务端 API / 考勤 > 考勤组管理 > groupKey转换为groupId
...
| group\_key | String | 是 | 02B1Exxxx | 考勤组ID，旧考勤组标识，可调用[批量获取考勤组详情](0178-batch-obtain-attendance-group-details.md)接口获取group\_id参数值。 |
