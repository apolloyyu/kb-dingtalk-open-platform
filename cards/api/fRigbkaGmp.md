...
archived: false
method: GET
endpoint: https://api.dingtalk.com/v1.0/agoal/objectiveRules/lists
api_version: v2-new
...
## Returns
- optional: requestId(String), success(Boolean), content(Array), OpenOrgObjectiveRuleDTO(OpenOrgObjectiveRuleDTO)
