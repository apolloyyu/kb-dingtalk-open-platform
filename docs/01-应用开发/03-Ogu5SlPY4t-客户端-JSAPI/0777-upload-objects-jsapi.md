...
doc_id: "MBV3FYafYt"
updated_at: "2026-09-02 18:14:10"
---

> Source: https://open.dingtalk.com/document/development/upload-objects-jsapi
> Path: 应用开发 / 客户端 JSAPI / 历史文档（不推荐） > H5微应用 > JSAPI参考 > 文件 > 上传文件
> Updated: 2026-09-02 18:14:10
...
| filePath | String | 是 | 文件的虚拟地址，如[选择图片](0789-select-picture.md)方法获取的图片虚拟路径。 |
