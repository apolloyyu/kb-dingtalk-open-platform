...
doc_id: "5ycpaVDdtN"
updated_at: "2026-08-25 09:39:31"
---

> Source: https://open.dingtalk.com/document/development/obtain-the-ids-of-multiple-form-instances
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 宜搭 > 表单 > 获取多个表单实例ID
> Updated: 2026-08-25 09:39:31
...
> - 未接入的开发者建议使用新版[获取多个表单实例ID](0323-api-searchformdataidlist-v2.md)接口，已接入用户不受影响。
