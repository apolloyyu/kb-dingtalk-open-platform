...
doc_id: "X7GH8sEK4N"
updated_at: "2026-08-25 09:39:21"
---

> Source: https://open.dingtalk.com/document/development/initiate-the-approval-process
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 宜搭 > 流程 > 发起宜搭审批流程
> Updated: 2026-08-25 09:39:21
...
> - 未接入的开发者建议使用新版[发起宜搭审批流程](0310-api-startinstance-v2.md)接口，已接入用户不受影响。
