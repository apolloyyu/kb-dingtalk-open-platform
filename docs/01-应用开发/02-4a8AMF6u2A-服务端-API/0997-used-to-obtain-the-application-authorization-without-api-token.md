...
- [获取工作台插件权限点](0999-obtain-the-permissions-of-the-workbench-plug-in.md)
- [批量添加最近使用应用](0998-add-recently-used-apps-in-bulk.md)
- [获取工作台插件检验的规则信息](1000-you-can-call-this-operation-to-obtain-the-information-about.md)
