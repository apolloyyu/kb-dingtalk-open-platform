...
doc_id: "BVehyTcvcO"
updated_at: "2026-08-25 09:39:22"
---

> Source: https://open.dingtalk.com/document/development/obtains-a-list-of-instance-ids
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 宜搭 > 流程 > 获取实例ID列表
> Updated: 2026-08-25 09:39:22
...
> - 未接入的开发者建议使用新版[获取实例ID列表](0309-api-getinstanceidlist-v2.md)接口，已接入用户不受影响。
