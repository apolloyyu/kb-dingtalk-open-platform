...
> Path: 应用开发 / 服务端 API / 通讯录管理 > 角色管理 > 创建角色
...
| groupId | Number | 是 | 1507113595 | 角色组ID。   - 如果要加入的角色组已存在，调用[获取角色列表](0088-obtains-a-list-of-enterprise-roles.md)接口获取。 - 如果尚未创建角色组，先调用[创建角色组](0090-add-a-role-group.md)接口创建角色组，并获取角色组ID。 |
