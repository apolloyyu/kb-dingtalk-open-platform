...
## Body
- dept_id (Number, required): 部门ID，可调用获取部门列表接口获取dept_id参数值。 **[!NOTE]** - 只获取当前部门下的员工信息，不包含子部门内的员工。 - 如果是根部门，该参数传1。
