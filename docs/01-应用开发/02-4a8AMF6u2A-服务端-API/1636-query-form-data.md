...
> - 未接入的开发者建议使用新版[查询表单数据](0317-api-getformdatabyid-v2.md)接口，已接入用户不受影响。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| id | String | 否 | 表单实例ID，可通过[获取多个表单实例ID](1637-obtain-the-ids-of-multiple-form-instances.md)接口获取。 |
