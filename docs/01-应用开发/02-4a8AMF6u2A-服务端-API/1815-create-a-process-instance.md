...
doc_id: "UGb6LxMeLw"
updated_at: "2026-08-27 14:18:00"
---

> Source: https://open.dingtalk.com/document/development/create-a-process-instance
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 生态开放 > 氚云 > 流程 > 创建流程实例
> Updated: 2026-08-27 14:18:00
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| schemaCode | String | 是 | 流程表单编码，非流程表单编码无法创建流程实例。 |
| bizObjectId | String | 是 | 业务数据实例ID。 |
| opUserId | String | 是 | 操作者的ID，此为氚云的用户ID，可调用[获取用户数据](1805-obtain-user-data.md)接口获取。 |
