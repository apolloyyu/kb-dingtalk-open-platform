...
| openConversationIds | Array of String | 否 | 群会话openConversationId，可调用[创建钉钉客联普通互通群](1849-create-common-group-new-version.md) / [创建钉钉客联两人互通群](1850-creating-two-groups-of-people.md)接口获取，长度限制为1～32个字符。 |
