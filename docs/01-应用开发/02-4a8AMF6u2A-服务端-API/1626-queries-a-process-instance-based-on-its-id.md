...
doc_id: "zDziVBJrRQ"
updated_at: "2026-08-25 09:39:24"
---

> Source: https://open.dingtalk.com/document/development/queries-a-process-instance-based-on-its-id
> Path: 应用开发 / 服务端 API / 历史文档（不推荐） > 宜搭 > 流程 > 根据流程实例ID获取流程实例
> Updated: 2026-08-25 09:39:24
...
> - 未接入的开发者建议使用新版[根据流程实例ID获取流程实例](0314-api-getinstancebyid-v2.md)接口，已接入用户不受影响。
