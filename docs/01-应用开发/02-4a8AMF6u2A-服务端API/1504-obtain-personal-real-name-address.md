...
doc_id: "xnhEYJNKqi"
updated_at: "2026-06-23 18:10:39"
---
...
当前接口已完成升级迭代且不再支持新应用申请，存量应用调用不受影响，建议未接入的开发者使用[获取个人实名的地址](1081-obtain-the-address-that-is-redirected-to-the-user-s-real.md)接口，已接入的开发者结合实际尽快完成迁移。
