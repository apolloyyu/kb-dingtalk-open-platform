...
| groupUuid | String | 否 | 分组标识，该参数需要在[如何开通使用设备上钉](1107-overview-of-equipment-nailing.md#section-amr-xz8-i5r)群内咨询。 |
| introduction | String | 否 | 设备的简介。 |
| roleUuid | String | 否 | 角色标识，该参数需要在[如何开通使用设备上钉](1107-overview-of-equipment-nailing.md#section-amr-xz8-i5r)群内咨询。 |
| typeUuid | String | 否 | 设备型号，该参数需要在[如何开通使用设备上钉](1107-overview-of-equipment-nailing.md#section-amr-xz8-i5r)群内咨询。 |
